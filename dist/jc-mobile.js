...
function photoTheme(T) {
  return Object.assign({}, T, {
    ...
    serif: FRAUNCES,
    sans: JOST,
    // serif = Fraunces (títulos/números/nombres), sans = Jost (cuerpo)
...
function PhotoBgLayers() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: "url('/assets/everest-mobile.jpg?v=11')", backgroundSize: "cover", backgroundPosition: "center top", backgroundRepeat: "no-repeat" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: MOBILE_BG_OVERLAY } }));
}
...
function MasTab({ T, openOverlay, onLogout, openNotif, goAnuladas }) {
  ...
  }, true)), /* @__PURE__ */ React.createElement("button", { onClick: onLogout, style: { ...glassPanel(T, 18), display: "flex", alignItems: "center", gap: 12, width: "100%", textAlign: "left", padding: "15px 16px", cursor: "pointer" } }, /* @__PURE__ */ React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#FF6B7D", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M15 4h3a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-3" }), /* @__PURE__ */ React.createElement("path", { d: "M10 8l-4 4 4 4" }), /* @__PURE__ */ React.createElement("path", { d: "M6 12h12" })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 14, color: "#FF6B7D" } }, "Cerrar sesi\xF3n")));
}
