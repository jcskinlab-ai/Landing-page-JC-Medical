...
function NuevaWizard({ T, appts, patients, addAppt, addPatient, onDone }) {
  ...
  } }, step > i + 1 ? "\u2713" : i + 1), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11, color: step >= i + 1 ? T.text : T.textFaint, whiteSpace: "nowrap" } }, s)), i < STEPS.length - 1 && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, height: 1, background: step > i + 1 ? T.accent : T.divider, marginBottom: 16 } })))), step === 1 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, [["existente", "Paciente existente"], ["nuevo", "Paciente nuevo"]].map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTipo(k), style: {
    flex: 1,
    fontFamily: T.sans,
    fontSize: 12,
