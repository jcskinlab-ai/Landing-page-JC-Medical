...
function HomeTab({ T, appts, patients, onOpenAppt, goTab, openOverlay }) {
  ...
  const kpi = (label, val, sub, subColor) => /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, ...glassPanel(T, 14), padding: "6px 8px 6px", display: "flex", flexDirection: "column", gap: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 8, letterSpacing: ".03em", textTransform: "uppercase", color: T.textMute, lineHeight: 1.2 } }, label), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FRAUNCES, fontSize: 21, fontWeight: 500, color: T.text, lineHeight: 1.1, letterSpacing: "-.01em" } }, val), sub && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 7.5, color: subColor || T.textMute, lineHeight: 1.1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, sub));
  const avatarSrc = (() => {
    try {
...
function AgendaTab({ T, appts, onOpenAppt, goTab, showAnuladas, setShowAnuladas }) {
  ...
  const searchResults = !ql ? [] : appts.filter((a) => (a.name || "").toLowerCase().includes(ql) || (a.rut || "").toLowerCase().includes(ql)).map((a) => ({ a, off: isoToDayOff(a.fecha || offToISO(a.day || 0)) })).sort((x, y) => {
  ...
  const searchBar = /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px 8px", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, ...glassChip(T), borderRadius: 13, padding: "0 14px" } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: T.textMute, strokeWidth: "1.8", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("circle", { cx: "11", cy: "11", r: "7" }), /* @__PURE__ */ React.createElement("path", { d: "M21 21l-4-4" })), /* @__PURE__ */ React.createElement("input", { value: q, onChange: (e) => setQ(e.target.value), placeholder: "Buscar por nombre, apellido o RUT\u2026", style: { flex: 1, background: "transparent", border: "none", outline: "none", color: T.text, fontFamily: T.sans, fontSize: 13.5, padding: "11px 0" } }), q && /* @__PURE__ */ React.createElement("button", { onClick: () => setQ(""), "aria-label": "Limpiar b\xFAsqueda", style: { flexShrink: 0, background: "none", border: "none", color: T.textMute, cursor: "pointer", padding: 4, display: "flex" } }, /* @__PURE__ */ React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M18 6 6 18M6 6l12 12" })))));
  const searchResultsBody = /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch", padding: "0 14px 16px" } }, searchResults.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { ...glassPanel(T, 14), padding: "22px 16px", textAlign: "center", fontFamily: T.sans, fontSize: 12.5, color: T.textMute } }, 'Sin resultados para "', q.trim(), '".'), searchResults.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 7 } }, searchResults.map((a) => {
    const st = apptStateM(a, T);
    const isAnulada = a.status === "anulada";
