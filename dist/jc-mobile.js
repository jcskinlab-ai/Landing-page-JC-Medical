...
function AgendaTab({ T, appts, onOpenAppt, goTab, showAnuladas, setShowAnuladas }) {
  ...
  }))), /* @__PURE__ */ React.createElement("div", { onClick: () => setDayMode((m) => m === "list" ? "cal" : "list"), style: { margin: "10px 16px 12px", flexShrink: 0, background: T.flatFill, border: "1px solid " + T.flatBorder, borderRadius: 16, padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "8.5" }), /* @__PURE__ */ React.createElement("path", { d: "M12 7.5V12l3 2" })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontWeight: 500, fontSize: 13, color: T.text } }, dayMode === "list" ? "Ver horarios disponibles" : "Ver lista de citas")), /* @__PURE__ */ React.createElement("svg", { width: "8", height: "14", viewBox: "0 0 8 14", fill: "none" }, /* @__PURE__ */ React.createElement("path", { d: "M1 1l6 6-6 6", stroke: T.textFaint, strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }))), dayMode === "list" ? /* @__PURE__ */ React.createElement("div", { className: "no-sb", style: { flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch", padding: "0 16px 8px", display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, fontWeight: 500, color: T.text } }, (() => {
