...
function LoginVideoBg({ children }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", minHeight: "100dvh", overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "30px 24px", backgroundColor: "#12294F" } }, /* @__PURE__ */ React.createElement(
    "video",
    {
      ...
      muted: true,
      playsInline: true,
      poster: "/assets/everest-mobile.jpg?v=5",
...
function MobileShell({ T, D, onLogout }) {
  ...
  const renderHeader = () => {
    if (tab === "citas") return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, minWidth: 0 } }, hamburger, /* @__PURE__ */ React.createElement("div", { style: { width: 34, height: 34, borderRadius: 10, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #4C8DF5, #2A5FD0)", boxShadow: "0 4px 12px -4px rgba(42,95,208,.7)", fontFamily: T.serif, fontSize: 18, color: "#fff", lineHeight: 1 } }, "M"), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 5, lineHeight: 1 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.serif, fontSize: 16, fontWeight: 400, color: T.text } }, "Medique"), clinName && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, "\xB7 ", clinName)), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9, letterSpacing: ".12em", textTransform: "uppercase", color: T.textFaint, display: "block", marginTop: 2 } }, "Panel m\xF3vil"))), bell);
