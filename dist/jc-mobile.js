...
function glassPanel(T, radius) {
  return {
    ...
    backdropFilter: "blur(34px) saturate(1.35) brightness(1.12)",
    WebkitBackdropFilter: "blur(34px) saturate(1.35) brightness(1.12)",
...
function glassChip(T) {
  return {
    ...
    backdropFilter: "blur(32px) saturate(1.3) brightness(1.1)",
    WebkitBackdropFilter: "blur(32px) saturate(1.3) brightness(1.1)",
...
function DaySummary({ T, c, p, na, prefix }) {
  const dot = (color, txt) => /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 5, whiteSpace: "nowrap" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 7, height: 7, borderRadius: "50%", background: color, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute } }, txt));
  const sep = /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11, color: T.textFaint } }, "\xB7");
  return /* @__PURE__ */ React.createElement("div", { style: { ...glassChip(T), borderRadius: 12, padding: "9px 12px", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, flexWrap: "wrap" } }, dot("#46D27A", (prefix ? prefix + " " : "") + c + " confirmada" + (c === 1 ? "" : "s")), sep, dot("#E8B84D", p + " pendiente" + (p === 1 ? "" : "s")), sep, dot("#FF6B7D", na + " no asisti\xF3"));
}
