...
function HomeTab({ T, appts, patients, onOpenAppt, goTab, openOverlay }) {
  ...
  const kpi = (label, val, sub, subColor) => /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, ...glassPanel(T, 14), padding: "6px 8px 6px", display: "flex", flexDirection: "column", gap: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 8, letterSpacing: ".03em", textTransform: "uppercase", color: T.textMute, lineHeight: 1.2 } }, label), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FRAUNCES, fontSize: 21, fontWeight: 500, color: T.text, lineHeight: 1.1, letterSpacing: "-.01em" } }, val), sub && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 7.5, color: subColor || T.textFaint, lineHeight: 1.1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, sub));
  const avatarSrc = (() => {
    try {
  ...
  const action = (icon, label, onClick, primary) => /* @__PURE__ */ React.createElement("button", { onClick, style: {
    ...
    padding: "5px 3px"
  } }, primary ? /* @__PURE__ */ React.createElement("div", { style: { width: 28, height: 28, borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, background: T.accent, color: "#fff", boxShadow: "0 4px 10px -4px " + T.accent } }, icon) : /* @__PURE__ */ React.createElement("div", { style: { height: 28, display: "flex", alignItems: "center", justifyContent: "center", color: "#A9BAC7" } }, icon), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9, fontWeight: 500, lineHeight: 1.05, textAlign: "center", color: T.text } }, label));
  return (
...
function AgendaTab({ T, appts, onOpenAppt, goTab, showAnuladas, setShowAnuladas }) {
  ...
  function apptBlock(a) {
    ...
    } }, /* @__PURE__ */ React.createElement("div", { style: { width: 3, alignSelf: "stretch", background: st.color, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, fontFamily: FRAUNCES, fontSize: 11.5, fontWeight: 500, color: T.text } }, a.time), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 12.5, fontWeight: 600, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", textDecoration: isAnulada ? "line-through" : "none" } }, abbrevNameM(a.name)), /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, marginRight: 10, fontFamily: T.sans, fontSize: 9, fontWeight: 700, color: st.color, background: "color-mix(in srgb, " + st.color + " 20%, transparent)", borderRadius: 5, padding: "2px 6px" } }, abbrevProcM(a.proc)));
  }
  ...
  if (view === "mes") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" } }, toggleRow, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 16px 8px", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setMonthCur((c) => {
      const m = c.m - 1;
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" } }, toggleRow, /* @__PURE__ */ React.createElement("div", { ref: stripRef, style: { overflowX: "auto", flexShrink: 0, WebkitOverflowScrolling: "touch" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", padding: "8px 10px 4px", minWidth: "max-content", gap: 2 } }, stripDays.map((d) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9.5, fontWeight: 500, color: isSel ? "#A9BAC7" : T.textMute } }, d.isToday ? "Hoy" : d.wd),
...
function OverlayShell({ T, title, onBack, children }) {
  return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 200, overflow: "hidden", backgroundColor: "#070B12", display: "flex", flexDirection: "column", maxWidth: 480, margin: "0 auto" } }, /* @__PURE__ */ React.createElement(PhotoBgLayers, null), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", zIndex: 1, display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "calc(14px + env(safe-area-inset-top,0px)) 18px 10px", display: "flex", alignItems: "center", gap: 14, flexShrink: 0 } }, /* @__PURE__ */ React.createElement("button", { onClick: onBack, "aria-label": "Volver", style: { width: 38, height: 38, borderRadius: "50%", ...glassChip(T), color: T.text, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "19", height: "19", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M15 18l-6-6 6-6" }))), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 26, fontWeight: 700, color: T.text, letterSpacing: "-.01em" } }, title)), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto" } }, children)));
}
