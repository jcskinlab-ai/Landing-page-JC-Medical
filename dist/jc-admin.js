...
function DashboardView({ T, D, A, appts, patients, go }) {
  ...
  const citaRow = (a) => /* @__PURE__ */ React.createElement("div", { key: a.id, style: { display: "flex", alignItems: "center", gap: 12, background: T.surface, border: "1px solid " + T.line, borderRadius: 10, padding: "12px 14px" } }, /* @__PURE__ */ React.createElement(Avatar, { T, name: a.name, size: 38 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13.5, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.proc)), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, fontWeight: 600, color: T.text } }, a.day === 0 ? "Hoy, " + (a.time || "\u2014") : a.when || a.time || "\u2014"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textFaint } }, (a.dur || 60) + " min")), /* @__PURE__ */ React.createElement("button", { onClick: () => go("agenda"), style: { flexShrink: 0, fontFamily: T.sans, fontSize: 11, fontWeight: 600, color: T.accent, background: "none", border: "1px solid " + T.line, borderRadius: 8, padding: "6px 12px", cursor: "pointer" } }, "Ver"));
...
function AdminApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "jc-stage", style: { background: T.dark ? "#070707" : "#DCD7CC" } }, /* @__PURE__ */ React.createElement("div", { className: "jc-admin-frame", style: { background: T.bg, boxShadow: T.shadow, color: T.text, display: "flex", flexDirection: "row" } }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 0, left: 0, bottom: 0, width: navOpen ? EXP : RAIL, background: SIDE_BG, borderRight: "1px solid " + SIDE_LINE, transition: "width .22s " + T.ease, overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: navOpen ? "8px 0 30px -10px rgba(0,0,0,.5)" : "none" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => nav("dashboard"), title: "Ir al Dashboard", style: { display: "flex", alignItems: "center", justifyContent: navOpen ? "flex-start" : "center", gap: 12, padding: navOpen ? "16px 18px" : "16px 0", background: "none", border: "none", cursor: "pointer", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 34, height: 34, borderRadius: 9, background: "#F2EDE6", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, boxShadow: "0 2px 8px -2px rgba(0,0,0,.4)" } }, /* @__PURE__ */ React.createElement("img", { src: SIDE_LOGO, alt: "Medique", style: { width: 30, height: 30, objectFit: "contain" } })), navOpen && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 13, letterSpacing: ".34em", textTransform: "lowercase", color: SIDE_MUTE, whiteSpace: "nowrap" } }, "medique")), /* @__PURE__ */ React.createElement("div", { className: "jc-scroll", style: { flex: 1, overflowY: "auto", overflowX: "hidden", padding: "6px 0" } }, adminNavItems().map((n) => {
      ...
      return /* @__PURE__ */ React.createElement("button", { key: n.k, onClick: () => nav(n.k), title: n.l, style: {
        display: "flex",
        alignItems: "center",
    ...
    r.readAsDataURL(f);
  } })), /* @__PURE__ */ React.createElement("button", { onClick: () => setNotifOpen(true), title: "Notificaciones", style: { position: "relative", width: 36, height: 36, borderRadius: "50%", border: "1px solid " + T.chipBorder, background: T.chipBg, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: T.textMute } }, /* @__PURE__ */ React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("path", { d: "M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9M13.7 21a2 2 0 0 1-3.4 0" })), pendCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: -2, right: -2, minWidth: 16, height: 16, padding: "0 4px", borderRadius: 999, background: "#C0285A", color: "#fff", fontFamily: T.sans, fontSize: 9, display: "flex", alignItems: "center", justifyContent: "center" } }, pendCount)), /* @__PURE__ */ React.createElement("button", { onClick: () => {
  ...
  })), /* @__PURE__ */ React.createElement("div", { className: "jc-scroll", style: { flex: 1, overflowY: "auto", padding: "18px 20px" } }, /* @__PURE__ */ React.createElement("div", { key: section + (openPatient || ""), style: { animation: "jcFade .3s " + T.ease, maxWidth: 1500, margin: "0 auto" } }, body))), /* @__PURE__ */ React.createElement(Copilot, { T, patients, appts, addAppt, onDarCita: (pf) => setDarCita(pf) }), darCita && /* @__PURE__ */ React.createElement(NewCitaModal, { T, patients, appts, time: darCita.time, day: darCita.day, prefill: darCita, onClose: () => setDarCita(null), onSave: (a) => {
    addAppt(a);
    setDarCita(null);
  }, onOpenPatient: (id) => {
    setOpenPatient(id);
    setSection("pacientes");
  } }), notifOpen && /* @__PURE__ */ React.createElement(NotifPopup, { T, patients, appts, onClose: () => setNotifOpen(false), go: (k) => {
    setNotifOpen(false);
    nav(k);
  }, openP: (id) => {
    setNotifOpen(false);
...
function Agenda({ T, appts, patients, addAppt, addPatient, updateAppt, removeAppt, onOpenPatient }) {
  ...
  for (let off = 0; off < 7; off++) {
    ...
    week.push({ off, dd: dt.getDate(), wd: wdN[dt.getDay()], lbl: off === 0 ? "Hoy" : off === 1 ? "Ma\xF1ana" : wdN[dt.getDay()], count: appts.filter((a) => a.day === off).length });
  }
...
function SemanaGrid({ T, week, appts, onNew, onEdit, updateAppt, removeAppt, onDay, onVerFicha }) {
  ...
  start.setDate(today.getDate() - today.getDay() + wkOff * 7);
  const days = [];
  for (let i = 0; i < 7; i++) {
  ...
  const wkHours = [];
  for (let h = WK_OPEN; h <= WK_CLOSE; h++) wkHours.push(h);
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 180, fontFamily: T.serif, fontSize: 21, color: T.text } }, days[0].dd, " de ", /* @__PURE__ */ React.createElement("span", { style: { fontStyle: "italic", color: T.accent } }, cap(MES[start.getMonth()])), " \u2013 ", last.getDate(), " de ", /* @__PURE__ */ React.createElement("span", { style: { fontStyle: "italic", color: T.accent } }, cap(MES[last.getMonth()]))), /* @__PURE__ */ React.createElement("button", { onClick: () => setWkOff(0), style: { fontFamily: T.sans, fontSize: 12, fontWeight: 500, color: wkOff === 0 ? T.textMute : T.text, background: T.surface, border: "1px solid " + T.line, borderRadius: 9, padding: "8px 16px", cursor: "pointer" } }, "Hoy"), /* @__PURE__ */ React.createElement("button", { onClick: () => setWkOff(wkOff - 1), title: "Semana anterior", style: navBtn }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M15 18l-6-6 6-6" }))), /* @__PURE__ */ React.createElement("button", { onClick: () => setWkOff(wkOff + 1), title: "Semana siguiente", style: navBtn }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M9 18l6-6-6-6" })))), /* @__PURE__ */ React.createElement("div", { className: "jc-scroll", style: { overflowX: "auto", overflowY: "auto", maxHeight: "74vh", border: "1px solid " + T.line, borderRadius: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 900 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "52px repeat(7, minmax(112px,1fr))", position: "sticky", top: 0, zIndex: 3, background: T.navBg, backdropFilter: "blur(8px)" } }, /* @__PURE__ */ React.createElement("div", { style: { borderBottom: "1px solid " + T.line } }), days.map((d, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { padding: "12px 4px 10px", textAlign: "center", borderBottom: "1px solid " + T.line, borderLeft: "1px solid " + T.lineSoft } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".1em", color: d.isToday ? T.accent : T.textMute } }, d.dow), d.isToday ? /* @__PURE__ */ React.createElement("div", { style: { margin: "3px auto 0", width: 30, height: 30, borderRadius: "50%", background: T.accent, color: T.onAccent || "#fff", fontFamily: T.serif, fontSize: 17, display: "flex", alignItems: "center", justifyContent: "center" } }, d.dd) : /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 19, color: T.text, marginTop: 2 } }, d.dd)))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", position: "relative" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 52, flexShrink: 0, position: "relative", height: wkGridH, borderRight: "1px solid " + T.lineSoft, overflow: "hidden" } }, wkHours.map((h, i) => /* @__PURE__ */ React.createElement("div", { key: h, style: { position: "absolute", top: i * WPX + 2, right: 6, fontFamily: T.sans, fontSize: 10, color: T.textFaint, pointerEvents: "none", userSelect: "none" } }, (h < 10 ? "0" : "") + h, ":00"))), days.map((d, ci) => {
    const da = appts.filter((a) => a.day === d.off && mins(a.time) >= WK_OPEN * 60 && mins(a.time) < (WK_CLOSE + 1) * 60);
    return /* @__PURE__ */ React.createElement("div", { key: ci, style: { flex: "1 1 0", minWidth: 112, position: "relative", height: wkGridH, borderLeft: "1px solid " + T.lineSoft, background: d.isToday ? T.accent + "08" : "transparent" } }, ADMIN_HALF_HOURS.map((hhmm, i) => {
      const isHourLine = hhmm.endsWith(":30");
      ...
      return /* @__PURE__ */ React.createElement("div", { key: hhmm, style: { position: "absolute", left: 0, right: 0, top: i * (WPX / 2), height: WPX / 2, borderBottom: isHourLine ? "1px solid " + T.lineSoft : "none" } }, !blocked && /* @__PURE__ */ React.createElement(
        "button",
        {
          className: "jc-cell",
        ...
        /* @__PURE__ */ React.createElement("span", { className: "jc-cell-add", style: { width: 20, height: 20, borderRadius: "50%", border: "1px solid " + T.line, color: T.accent, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("svg", { width: "11", height: "11", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.4", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M12 5v14M5 12h14" })))
      ));
    }), stackAppts(da).map((a) => {
  ...
  ].map((it, i) => it[0] === "__sep" ? /* @__PURE__ */ React.createElement("div", { key: i, style: { height: 1, background: T.lineSoft, margin: "4px 0" } }) : /* @__PURE__ */ React.createElement("button", { key: i, onClick: it[1], style: { display: "block", width: "100%", textAlign: "left", padding: "10px 14px", background: "none", border: "none", cursor: "pointer", fontFamily: T.sans, fontSize: 12.5, color: it[0] === "Anular" ? "#C0285A" : it[2] || T.text } }, it[0])))));
}
function Summ({ T, k, v }) {
...
function NewCitaModal({ T, patients, addPatient, time, day, onClose, onSave, prefill, appts, onOpenPatient }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    }, style: selStyle }, /* @__PURE__ */ React.createElement("option", null, "Todas"), especialidades.map((s) => /* @__PURE__ */ React.createElement("option", { key: s }, s)))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Procedimiento"), /* @__PURE__ */ React.createElement("select", { value: proc, onChange: (e) => setProc(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", { value: "Evaluaci\xF3n general" }, "Evaluaci\xF3n general"), procsByEsp.map((p) => /* @__PURE__ */ React.createElement("option", { key: p, value: p }, p)))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Profesional"), /* @__PURE__ */ React.createElement("select", { value: prof, onChange: (e) => setProf(e.target.value), style: selStyle }, team.map((t) => /* @__PURE__ */ React.createElement("option", { key: t.id, value: t.name }, t.name)))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Recurso"), /* @__PURE__ */ React.createElement("select", { value: recurso, onChange: (e) => setRecurso(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", null, "No especificado"), /* @__PURE__ */ React.createElement("option", null, "Sala de procedimientos"), /* @__PURE__ */ React.createElement("option", null, "Sala de evaluaci\xF3n"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Box / Camilla"), /* @__PURE__ */ React.createElement("select", { value: camilla, onChange: (e) => setCamilla(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", null, "Box 1"), /* @__PURE__ */ React.createElement("option", null, "Box 2"), /* @__PURE__ */ React.createElement("option", null, "Camilla 1"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Duraci\xF3n"), /* @__PURE__ */ React.createElement("select", { value: dur, onChange: (e) => setDur(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", null, "15 minutos"), /* @__PURE__ */ React.createElement("option", null, "30 minutos"), /* @__PURE__ */ React.createElement("option", null, "45 minutos"), /* @__PURE__ */ React.createElement("option", null, "60 minutos")))), /* @__PURE__ */ React.createElement("div", { style: { overflowX: "auto" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, minmax(80px,1fr))", gap: 6, minWidth: 620 } }, week.map((w) => /* @__PURE__ */ React.createElement("div", { key: w.off, style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10, letterSpacing: ".06em", textTransform: "uppercase", color: T.textMute, paddingBottom: 4 } }, w.wd), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 15, color: T.text, paddingBottom: 8 } }, w.dd, " ", w.mm), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, ADMIN_HALF_HOURS.map((h) => {
      const sel = pick && pick.dayOff === w.off && pick.time === h;
      const blk = (appts || []).some((a) => {
        if (a.day !== w.off) return false;
  ...
  return /* @__PURE__ */ React.createElement(
    AdModal,
    {
      ...
      footer: /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, appt.status === "pendiente_pago" && /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => onSave({ proc, fecha, time: t, status: "confirmada", comentario, origen, dur }),
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lblS(T) }, "Procedimiento"), /* @__PURE__ */ React.createElement("select", { value: proc, onChange: (e) => setProc(e.target.value), style: selS(T) }, /* @__PURE__ */ React.createElement("option", { value: "Evaluaci\xF3n general" }, "Evaluaci\xF3n general"), procs.map((p) => /* @__PURE__ */ React.createElement("option", { key: p, value: p }, p)))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lblS(T) }, "Fecha"), /* @__PURE__ */ React.createElement(MiniCalendar, { T, selected: fecha, onSelect: setFecha })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lblS(T) }, "Hora"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "time",
        value: t,
...
function WelcomeTour({ T, go, onClose }) {
  ...
  function addTeam() {
    ...
    var n = team.concat([{ id: uid("t"), name: tN.trim(), role: tR.trim() || "Profesional", active: true, color: "#8B9EB0" }]);
    setTeam(n);
    try {
      DB.set("team", n);
    } catch (e) {
  ...
  function addSvc() {
    ...
    var n = [{ id: uid("svc"), name: sN.trim(), cat: "Otro", price: parseInt((sP + "").replace(/\D/g, ""), 10) || 0, dur: parseInt(sD, 10) || 30, pts: 0, desc: "" }].concat(svcs);
    setSvcs(n);
    try {
  ...
  function addInv() {
    ...
    var n = inv.concat([{ id: uid("i"), name: iN.trim(), cat: "Insumo cl\xEDnico", stock: parseInt((iS + "").replace(/\D/g, ""), 10) || 0, min: 0, unit: iU || "unidades", price: 0 }]);
    setInv(n);
    try {
      DB.set("inv_items", n);
    } catch (e) {
