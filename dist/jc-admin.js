...
function DashboardView({ T, D, A, appts, patients, go }) {
  ...
  const green = "#1F8A5B";
  const glassPanel = !lux ? { background: T.surface, border: "1px solid " + T.line, borderRadius: 16, boxShadow: T.shadow } : T.dark ? { background: "rgba(255,255,255,.045)", backdropFilter: "blur(30px) saturate(1.4)", WebkitBackdropFilter: "blur(30px) saturate(1.4)", border: "1px solid rgba(255,255,255,.09)", borderRadius: 22, boxShadow: "inset 0 1px 0 rgba(255,255,255,.07), 0 32px 72px -44px rgba(0,0,0,.85)" } : { background: "rgba(255,255,255,.42)", backdropFilter: "blur(30px) saturate(1.4)", WebkitBackdropFilter: "blur(30px) saturate(1.4)", border: "1px solid rgba(255,255,255,.85)", borderRadius: 22, boxShadow: "inset 0 1px 0 rgba(255,255,255,.9), 0 24px 56px -36px rgba(60,58,50,.16)" };
  ...
  return /* @__PURE__ */ React.createElement("div", { style: lux ? { maxWidth: 1180, margin: "0 auto" } : void 0 }, lux ? /* @__PURE__ */ React.createElement("div", { style: { margin: "6px 0 26px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: navyAccent } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || navyAccent } }), _greet, clinicDisplayName() ? ", " + clinicDisplayName() : ""), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: "clamp(26px, 3vw, 34px)", letterSpacing: "-.01em", color: T.text, marginTop: 10, lineHeight: 1.05, textTransform: "capitalize" } }, _fechaLarga), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")) : /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 300, fontSize: 28, letterSpacing: "-.02em", color: T.text, lineHeight: 1.1 } }, _greet, clinicDisplayName() ? ", " + clinicDisplayName().split(" ")[0] : "", "."), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 5 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: lux ? "flex-start" : "center", marginBottom: lux ? 18 : 22 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", gap: 4, background: T.surface, border: "1px solid " + T.line, borderRadius: 999, padding: 3 } }, TABS.map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTab(k), style: { fontFamily: T.sans, fontSize: lux ? 11.5 : 12.5, fontWeight: tab === k ? 600 : 500, padding: lux ? "7px 15px" : "8px 18px", borderRadius: 999, cursor: "pointer", border: "none", background: tab === k ? navyAccent : "transparent", color: tab === k ? T.onAccent || "#fff" : T.textMute, transition: "all .18s " + T.ease } }, l)))), tab === "general" && lux && (() => {
...
function AdminApp() {
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, padding: shellLux ? "12px 18px 6px" : "13px 18px 10px", borderBottom: "1px solid " + (shellLux ? "transparent" : T.line), background: shellLux ? "transparent" : T.navBg, backdropFilter: shellLux ? "none" : "blur(16px)", WebkitBackdropFilter: shellLux ? "none" : "blur(16px)", position: "relative", zIndex: 6, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(PatientSearch, { T, patients, compact: shellLux, onOpen: (id) => {
    setOpenPatient(id);
    setSection("pacientes");
...
function AdStat({ T, n, l, accent }) {
  ...
  if (luxF) return /* @__PURE__ */ React.createElement("div", { style: { ...DS.card(T), padding: "14px 12px", textAlign: "center", borderColor: accent ? "#C0285A55" : T.line } }, /* @__PURE__ */ React.createElement("div", { style: { ...DS.text(T, "stat"), fontSize: 24, color: accent ? "#C0285A" : T.text } }, n), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: DS.ft.eyebrow, letterSpacing: ".12em", textTransform: "uppercase", color: T.textMute, marginTop: 6 } }, l));
...
function Agenda({ T, appts, patients, addAppt, addPatient, updateAppt, removeAppt, onOpenPatient, onSyncWeb, initialApptId, onConsumeApptId }) {
  ...
  const isBase = true;
  const DS = window.JCDS, luxF = DS && (typeof jcdsLux === "function" ? jcdsLux() : false);
  const viewToggleNode = /* @__PURE__ */ React.createElement("div", { style: luxF ? { display: "inline-flex", gap: 2, background: T.surface2 || T.surface, border: "1px solid " + T.line, borderRadius: DS.r.ctl + 2, padding: 3 } : { display: "inline-flex", gap: 4, background: T.surface, border: "1px solid " + T.line, borderRadius: 9, padding: 4 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setView("dia"), title: "Vista lista / d\xEDa", style: luxF ? { display: "flex", alignItems: "center", justifyContent: "center", width: 34, height: 30, borderRadius: DS.r.ctl, cursor: "pointer", border: "none", background: view === "dia" ? T.surface : "transparent", boxShadow: view === "dia" ? "0 1px 2px rgba(0,0,0,.06)" : "none", color: view === "dia" ? T.accent : T.textMute, transition: DS.trans("background,box-shadow,color") } : { display: "flex", alignItems: "center", justifyContent: "center", width: 36, height: 32, borderRadius: 7, cursor: "pointer", border: "none", background: view === "dia" ? T.accent : "transparent", color: view === "dia" ? T.onAccent || "#fff" : T.textMute } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" }))), /* @__PURE__ */ React.createElement("button", { onClick: () => setView("semana"), title: "Vista calendario / semana", style: luxF ? { display: "flex", alignItems: "center", justifyContent: "center", width: 34, height: 30, borderRadius: DS.r.ctl, cursor: "pointer", border: "none", background: view === "semana" ? T.surface : "transparent", boxShadow: view === "semana" ? "0 1px 2px rgba(0,0,0,.06)" : "none", color: view === "semana" ? T.accent : T.textMute, transition: DS.trans("background,box-shadow,color") } : { display: "flex", alignItems: "center", justifyContent: "center", width: 36, height: 32, borderRadius: 7, cursor: "pointer", border: "none", background: view === "semana" ? T.accent : "transparent", color: view === "semana" ? T.onAccent || "#fff" : T.textMute } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 9h18M8 2v4M16 2v4" }))), /* @__PURE__ */ React.createElement("button", { onClick: () => setView("mes"), title: "Vista mensual", style: luxF ? { display: "flex", alignItems: "center", justifyContent: "center", width: 34, height: 30, borderRadius: DS.r.ctl, cursor: "pointer", border: "none", background: view === "mes" ? T.surface : "transparent", boxShadow: view === "mes" ? "0 1px 2px rgba(0,0,0,.06)" : "none", color: view === "mes" ? T.accent : T.textMute, transition: DS.trans("background,box-shadow,color") } : { display: "flex", alignItems: "center", justifyContent: "center", width: 36, height: 32, borderRadius: 7, cursor: "pointer", border: "none", background: view === "mes" ? T.accent : "transparent", color: view === "mes" ? T.onAccent || "#fff" : T.textMute } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 10h18M8 2v4M16 2v4" }), /* @__PURE__ */ React.createElement("circle", { cx: "8", cy: "14.5", r: "1", fill: "currentColor", stroke: "none" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "14.5", r: "1", fill: "currentColor", stroke: "none" }), /* @__PURE__ */ React.createElement("circle", { cx: "16", cy: "14.5", r: "1", fill: "currentColor", stroke: "none" }))));
  ...
  return /* @__PURE__ */ React.createElement("div", null, luxF && /* @__PURE__ */ React.createElement("div", { style: { margin: "6px 0 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), "Agenda de la cl\xEDnica"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: "clamp(24px, 2.6vw, 30px)", letterSpacing: "-.01em", color: T.text, margin: "10px 0 0", lineHeight: 1.05 } }, "Reservas y Citas"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, (() => {
    const n = appts.filter((a) => apptDayOff(a) === 0 && a.status !== "anulada").length;
    return n === 0 ? "No hay citas para hoy." : n + " cita" + (n === 1 ? "" : "s") + " hoy.";
  })(), " Gestiona horarios, confirma asistencias y agenda nuevas atenciones.")), !isBase && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, marginBottom: 18, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 46, height: 46, borderRadius: 12, background: T.accent + "18", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 9h18M8 2v4M16 2v4" }))), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 200 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 300, fontSize: 28, letterSpacing: "-.02em", color: T.text, margin: 0 } }, "Reservas y Citas"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 2 } }, "Gestiona la agenda de la cl\xEDnica, confirma asistencias y asigna puntos.")), viewToggleNode, onSyncWeb && /* @__PURE__ */ React.createElement(AdBtn, { T, onClick: traerWeb }, webBusy ? "Trayendo\u2026" : "\u21BB Traer reservas web"), nuevaBtnNode), isBase && view === "dia" && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontFamily: T.serif, fontSize: 18, color: T.text } }, luxF ? "" : "Reservas y Citas"), viewToggleNode, icsBtnNode, nuevaBtnNode), view === "semana" ? /* @__PURE__ */ React.createElement(SemanaGrid, { T, week, appts, viewToggle: viewToggleNode, nuevaBtn: nuevaBtnNode, icsBtn: icsBtnNode, onNew: (off, time) => setNueva({ time, day: off, fromSlot: true }), onEdit: (appt, only) => {
    setEdit(appt);
...
function MonthGrid({ T, appts, monthDate, setMonthDate, onDay, viewToggle, nuevaBtn }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setMonthDate(new Date(y, m - 1, 1)), style: navBtn, title: "Mes anterior" }, "\u2039"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontFamily: T.serif, fontSize: 18, color: T.text, textTransform: "capitalize" } }, monthLbl), /* @__PURE__ */ React.createElement("button", { onClick: () => setMonthDate(new Date(y, m + 1, 1)), style: navBtn, title: "Mes siguiente" }, "\u203A"), viewToggle, nuevaBtn), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 1, background: T.line, border: "1px solid " + T.line, borderRadius: 10, overflow: "hidden" } }, diasSemana.map((d) => /* @__PURE__ */ React.createElement("div", { key: d, style: { background: T.surface2 || T.surface, padding: "8px 6px", textAlign: "center", fontFamily: T.sans, fontSize: 10, letterSpacing: ".08em", textTransform: "uppercase", color: T.textMute } }, d)), cells.map((d, i) => {
    if (!d) return /* @__PURE__ */ React.createElement("div", { key: i, style: { background: T.bg, minHeight: 92 } });
    const iso = toISO(d);
    const list = apptsByDay[iso] || [];
    const isToday = iso === toISO(today);
    return /* @__PURE__ */ React.createElement("button", { key: i, onClick: () => onDay(offOf(d)), style: { textAlign: "left", background: T.surface, minHeight: 92, padding: "6px 7px", border: "none", cursor: "pointer", display: "flex", flexDirection: "column", gap: 3 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11.5, fontWeight: isToday ? 700 : 500, color: isToday ? T.accent : T.text, width: 20, height: 20, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "50%", background: isToday ? T.accentSoft || "transparent" : "transparent" } }, d.getDate()), list.slice(0, 3).map((a, idx) => /* @__PURE__ */ React.createElement("span", { key: idx, style: { fontFamily: T.sans, fontSize: 9.5, color: T.textMute, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.time ? a.time + " " : "", a.name || "Cita")), list.length > 3 && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9, color: T.accent } }, "+", list.length - 3, " m\xE1s"));
  })));
}
    ...
    return /* @__PURE__ */ React.createElement("div", { key: ci, style: { flex: "1 1 0", minWidth: 112, position: "relative", height: wkGridH, borderLeft: "1px solid " + T.lineSoft, background: d.isToday ? T.accent + "08" : "transparent" } }, slots.map((hhmm, i) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        v2 ? (
          ...
          /* @__PURE__ */ React.createElement("div", { style: { height: "100%", cursor: "pointer", background: isPendPago ? "#B8860B" + (T.dark ? "22" : "16") : accentColor + (T.dark ? luxF ? "1e" : "26" : luxF ? "14" : "1c"), ...luxF ? { backdropFilter: "blur(12px) saturate(1.25)", WebkitBackdropFilter: "blur(12px) saturate(1.25)" } : {}, border: "1px solid " + accentColor + (luxF ? "2a" : "33"), borderLeft: "4px solid " + accentColor, borderRadius: luxF ? 8 : 6, padding: "0 6px 0 5px", overflow: "hidden", display: "flex", alignItems: "center", gap: 5 } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 11, fontWeight: 600, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name), a.proc && /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, width: 15, height: 15, borderRadius: 3, background: accentColor + "33", color: accentColor, fontFamily: T.sans, fontSize: 8.5, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center", letterSpacing: 0 } }, a.proc[0].toUpperCase()))
