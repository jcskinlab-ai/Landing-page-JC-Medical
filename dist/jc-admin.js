...
if (typeof window !== "undefined") {
  window.jcmNorm = jcmNorm;
  window.jcmPatientMatch = jcmPatientMatch;
}
...
function AdminApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "jc-stage", style: { background: T.dark ? "#070707" : "#DCD7CC" } }, /* @__PURE__ */ React.createElement("div", { className: "jc-admin-frame", style: { ...everestBg ? { backgroundImage: everestBg, backgroundSize: "cover", backgroundPosition: "center top", backgroundRepeat: "no-repeat" } : { background: T.bg }, boxShadow: T.shadow, color: T.text, display: "flex", flexDirection: "row" } }, showSidebar && /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    const patMatches = !q ? [] : patients.filter((p) => jcmPatientMatch(p, q)).slice(0, 6).map((p) => ({ type: "patient", id: p.id, label: p.name || "Sin nombre", sub: [p.rut, p.age ? p.age + " a\xF1os" : ""].filter(Boolean).join(" \xB7 ") }));
...
function Resumen({ T, D, A, appts, patients, go, updateAppt, removeAppt, themeKey, setThemeKey }) {
  ...
  if (typeof isLosMedique === "function" && isLosMedique()) {
    ...
    const listRow = (a, showDay) => /* @__PURE__ */ React.createElement(
      ...
      {
        key: a.id,
        ...jcmLinkProps(jcmPanelHref("agenda", null, a.id), () => setEdit(a)),
        style: { display: "flex", alignItems: "center", gap: 14, padding: "13px 4px", background: "none", border: "none", borderBottom: "1px solid " + T.lineSoft, cursor: "pointer", textAlign: "left", width: "100%", boxSizing: "border-box", textDecoration: "none", color: "inherit", transition: "background .18s " + T.ease },
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1180, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 26 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: 40, letterSpacing: "-.015em", color: T.text, marginTop: 0, lineHeight: 1.02, textTransform: "capitalize" } }, fechaLarga), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, wkCitas, " ", wkCitas === 1 ? "cita" : "citas", " esta semana", wkMonto > 0 ? " \xB7 " + D.fmt(wkMonto) + " cobrado" : "")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px, 1fr))", gap: 14, marginBottom: 26 } }, kpis.map((k, i) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: i,
        onClick: k.onClick,
...
function ApptBlock({ T, a, onClick, compact }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { "data-appt": true, onClick: (e) => {
    e.stopPropagation();
    onClick(a);
  }, style: { cursor: "pointer", background: T.surface2, border: "1px solid " + st.color + "66", borderRadius: 6, padding: compact ? "5px 7px" : "8px 11px", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", gap: 6, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 6, minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { width: 6, height: 6, borderRadius: "50%", background: st.color, flexShrink: 0 } }), a.proc && /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", title: jcmProcColor(a.proc).label, style: { width: 6, height: 6, borderRadius: "50%", background: jcmProcColor(a.proc).color, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: compact ? 10.5 : 12.5, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, nameLabel)), !compact && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11, color: st.color, flexShrink: 0 } }, a.time)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: compact ? 9 : 10.5, color: T.textMute, marginTop: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, compact ? a.time + " \xB7 " + a.proc : a.proc), !compact && st.key !== "pendiente" && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 4, display: "inline-block", fontFamily: T.sans, fontSize: 9, fontWeight: 600, letterSpacing: ".04em", color: st.color, background: st.color + "1a", borderRadius: 5, padding: "2px 6px" } }, st.label));
}
...
function Agenda({ T, appts, patients, addAppt, addPatient, updateAppt, removeAppt, onOpenPatient, onSyncWeb, initialApptId, onConsumeApptId }) {
  ...
  return (
    ...
    /* @__PURE__ */ React.createElement("div", { style: luxF ? { maxWidth: 1560, margin: "0 auto" } : void 0 }, luxF && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { margin: "0 0 12px" } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: "clamp(19px, 2vw, 23px)", letterSpacing: "-.01em", color: T.text, margin: 0, lineHeight: 1.05, textShadow: heroShadow } }, "Reservas y Citas"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute, marginTop: 4, textShadow: heroShadow } }, n === 0 ? "No hay citas para hoy." : n + " cita" + (n === 1 ? "" : "s") + " hoy.", " Gestiona horarios, confirma asistencias y agenda nuevas atenciones."));
...
function jcmProcColor(proc) {
  ...
  if (/botox|toxina|b[oó]tox|bruxismo|maset|hiperhidros|axila/.test(p)) return { key: "botox", label: "Toxina botul\xEDnica", color: JCM_PROC_COLORS.botox };
  if (/hialur|[aá]cido h|relleno|labio|rinomodel|ojera|surco|perfilado|mentón|menton/.test(p)) return { key: "ah", label: "\xC1cido hialur\xF3nico", color: JCM_PROC_COLORS.ah };
...
function MonthGrid({ T, appts, monthDate, setMonthDate, onDay, viewToggle, icsBtn, nuevaBtn }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 34, height: 34, borderRadius: 9, background: T.accent + "18", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 9h18M8 2v4M16 2v4" }))), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 18, color: T.text, whiteSpace: "nowrap" } }, monthLbl), /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setMonthDate(/* @__PURE__ */ new Date()), style: { ...navBtn, width: "auto", padding: "0 15px", fontSize: 12.5 } }, "Hoy"), /* @__PURE__ */ React.createElement("button", { onClick: () => setMonthDate(new Date(y, m - 1, 1)), style: navBtn, title: "Mes anterior" }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M15 18l-6-6 6-6" }))), /* @__PURE__ */ React.createElement("button", { onClick: () => setMonthDate(new Date(y, m + 1, 1)), style: navBtn, title: "Mes siguiente" }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M9 18l6-6-6-6" })))), viewToggle, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 8 } }), multiProf && /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setProfOpen((o) => !o), title: "Ver agenda de un profesional", style: { display: "flex", alignItems: "center", gap: 8, height: 34, padding: "0 12px 0 5px", border: "1px solid " + T.line, borderRadius: 9, color: T.text, fontFamily: T.sans, fontSize: 12.5, cursor: "pointer", maxWidth: 220, ...ctlGlass } }, /* @__PURE__ */ React.createElement("span", { style: { width: 24, height: 24, borderRadius: "50%", background: selProfColor + "22", color: selProfColor, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 700, flexShrink: 0 } }, profIni(selProf)), /* @__PURE__ */ React.createElement("span", { style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, selProf || "Profesional"), /* @__PURE__ */ React.createElement("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.2" }, /* @__PURE__ */ React.createElement("path", { d: "M6 9l6 6 6-6" }))), profOpen && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { onClick: () => setProfOpen(false), style: { position: "fixed", inset: 0, zIndex: 60 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 40, right: 0, minWidth: 210, background: T.bg, border: "1px solid " + T.line, borderRadius: 10, boxShadow: "0 18px 44px -20px rgba(0,0,0,.55)", zIndex: 61, overflow: "hidden", padding: 4 } }, team.map((t2) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0,1fr))", border: gridLine, borderRadius: 12, overflow: "hidden", ...cellBlur } }, diasSemana.map((d, i) => /* @__PURE__ */ React.createElement("div", { key: d, style: { background: veilHead, padding: "9px 6px", textAlign: "center", fontFamily: T.sans, fontSize: 10.5, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: isCurMonth && i === todayCol ? T.accent : T.textMute, borderRight: i < 6 ? gridLine : "none", borderBottom: gridLine, minWidth: 0 } }, d)), cells.map((d, i) => {
      ...
      if (!d) return /* @__PURE__ */ React.createElement("div", { key: i, style: { background: veil, minHeight: 100, minWidth: 0, ...cellBorders } });
      const iso = toISO(d);
      const list = apptsByDay[iso] || [];
      const isToday = iso === toISO(today);
      const ordered = list.slice().sort((x, y2) => (x.time || "").localeCompare(y2.time || ""));
      return /* @__PURE__ */ React.createElement("button", { key: i, onClick: () => onDay(offOf(d)), style: { textAlign: "left", background: isToday ? T.accent + "1e" : veil, minHeight: 100, minWidth: 0, padding: "7px 7px", border: "none", ...cellBorders, cursor: "pointer", display: "flex", flexDirection: "column", gap: 3 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: isToday ? 700 : 500, color: isToday ? T.accent : T.text, width: 22, height: 22, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "50%", background: isToday ? T.accent + "33" : "transparent", flexShrink: 0 } }, d.getDate()), ordered.slice(0, 3).map((a, idx) => {
        const c = jcmApptState(a, T).color;
        return /* @__PURE__ */ React.createElement("span", { key: idx, title: (a.time ? a.time + " \xB7 " : "") + (a.name || "Cita") + (a.proc ? " \xB7 " + a.proc : ""), style: { display: "flex", alignItems: "center", gap: 5, background: chipBg, ...cellBlur, borderRadius: 4, padding: "2px 6px", fontFamily: T.sans, fontSize: 9.5, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { width: 5, height: 5, borderRadius: "50%", background: c, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { width: 5, height: 5, borderRadius: "50%", background: jcmProcColor(a.proc).color, flexShrink: 0 } }), a.time ? a.time + " " : "", a.name || "Cita");
...
function SemanaGrid({ T, week, appts, onNew, onEdit, updateAppt, removeAppt, onDay, onVerFicha, viewToggle, nuevaBtn, icsBtn }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, (() => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: ci, style: { flex: "1 1 0", minWidth: 112, position: "relative", height: wkGridH, borderLeft: "1px solid " + T.lineSoft, background: d.isToday ? T.accent + "08" : "transparent" } }, slots.map((hhmm, i) => {
      ...
      const procC = jcmProcColor(a.proc).color;
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        v2 ? (
          /* Estilo "Medilink barra": tinte leve del color del estado (ya no barra lateral —
             ...
             pastel opaco. */
          /* @__PURE__ */ React.createElement("div", { style: { height: "100%", cursor: "pointer", background: isPendPago ? "#B8860B" + (T.dark ? "22" : "16") : accentColor + (T.dark ? luxF ? "1e" : "26" : luxF ? "14" : "1c"), ...luxF ? { backdropFilter: window.JCDS.glassBlur.small, WebkitBackdropFilter: window.JCDS.glassBlur.small } : {}, border: "1px solid " + accentColor + (luxF ? "2a" : "33"), borderRadius: luxF ? DS.r.ctl : 6, padding: tall ? "4px 6px 4px 8px" : "0 6px 0 8px", overflow: "hidden", display: "flex", alignItems: tall ? "stretch" : "center", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", justifyContent: "center", gap: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 11, fontWeight: 600, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name), /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, fontFamily: T.sans, fontSize: 10, fontWeight: 600, color: T.text } }, a.time)), tall && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 9.5, color: T.textMute, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, isPendPago ? "\u23F3 Pago pendiente" : a.proc || "Cita"), /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, fontFamily: T.sans, fontSize: 9.5, color: T.textFaint } }, "\u2013 ", horaFin))), a.proc && /* @__PURE__ */ React.createElement("span", { title: jcmProcColor(a.proc).label, style: { flexShrink: 0, alignSelf: tall ? "flex-start" : "center", width: 15, height: 15, borderRadius: 3, background: procC + "33", color: procC, fontFamily: T.sans, fontSize: 8.5, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center", letterSpacing: 0 } }, /bioestim/i.test(a.proc) ? "S" : a.proc[0].toUpperCase()))
        ) : /* @__PURE__ */ React.createElement("div", { style: { height: "100%", cursor: "pointer", background: isPendPago ? "#FFF8E122" : T.surface, border: "1px solid " + (isPendPago ? "#B8860B44" : T.line), borderRadius: 6, padding: "4px 6px", overflow: "hidden", boxShadow: "0 2px 6px rgba(40,38,30,.08)" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 6, height: 6, borderRadius: "50%", background: accentColor, flexShrink: 0 } }), a.proc && /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", title: jcmProcColor(a.proc).label, style: { width: 6, height: 6, borderRadius: "50%", background: procC, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 11, fontWeight: 600, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name)), a._h > 26 && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 9.5, color: T.textMute, marginTop: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.time, " \xB7 ", parseInt(a.dur) || 60, " min", a.proc ? " \xB7 " + (isPendPago ? "\u23F3 Pago pendiente" : a.proc) : ""))
      );
    }));
...
function NewCitaModal({ T, patients, addPatient, time, day, onClose, onSave, prefill, appts, onOpenPatient, addAppt }) {
  ...
  for (let off = 0; off < 7; off++) {
    const dt = new Date(b0);
    dt.setDate(b0.getDate() + off);
    week.push({ off, dd: dt.getDate(), mm: _MESES3[dt.getMonth()], wd: wdN2[dt.getDay()], wday: dt.getDay() });
  }
  const dayInfo = (off) => {
    const dt = new Date(b0);
    dt.setDate(b0.getDate() + off);
    return { wd: wdN2[dt.getDay()], dd: dt.getDate(), mm: _MESES3[dt.getMonth()] };
  };
  ...
  const [pick, setPick] = useState(pfValid ? { dayOff: pf.day || 0, time: pf.time } : pf.time ? nextFree : null);
  ...
  if (step === 2) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 10, marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Hora"), /* @__PURE__ */ React.createElement("input", { type: "time", step: "900", value: pick.time, onChange: (e) => e.target.value && setPick({ ...pick, time: e.target.value }), style: selStyle })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Tratamiento"), /* @__PURE__ */ React.createElement("select", { value: proc, onChange: (e) => setProc(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", { value: "Evaluaci\xF3n general" }, "Evaluaci\xF3n general"), (window.JCDATA && window.JCDATA.catalog ? window.JCDATA.catalog : []).map((sec) => /* @__PURE__ */ React.createElement("optgroup", { key: sec.sec, label: sec.sec }, sec.groups.flatMap((g) => g.items).map((it) => /* @__PURE__ */ React.createElement("option", { key: it.n, value: it.n }, it.n)))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Duraci\xF3n"), /* @__PURE__ */ React.createElement("select", { value: dur, onChange: (e) => setDur(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", null, "15 minutos"), /* @__PURE__ */ React.createElement("option", null, "30 minutos"), /* @__PURE__ */ React.createElement("option", null, "45 minutos"), /* @__PURE__ */ React.createElement("option", null, "60 minutos"), /* @__PURE__ */ React.createElement("option", null, "90 minutos")))),
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    nextFree && (() => {
      const di = dayInfo(nextFree.dayOff);
      const isSel = pick && pick.dayOff === nextFree.dayOff && pick.time === nextFree.time;
      return /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => setPick({ dayOff: nextFree.dayOff, time: nextFree.time }),
          style: {
            display: "inline-flex",
            alignItems: "center",
            gap: 8,
            ...
            borderRadius: 999,
            cursor: "pointer",
            background: isSel ? T.accent + "1e" : T.surface2 || T.accent + "10",
            border: "1px solid " + (isSel ? T.accent + "88" : T.line),
            fontFamily: T.sans
          }
        },
        /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { width: 7, height: 7, borderRadius: "50%", background: "#16A34A", flexShrink: 0 } }),
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: T.textMute } }, "Pr\xF3ximo disponible:"),
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12.5, fontWeight: 600, color: T.text } }, di.wd, " ", di.dd, " ", di.mm, " \xB7 ", nextFree.dayOff === 0 ? "hoy " : nextFree.dayOff === 1 ? "ma\xF1ana " : "", nextFree.time),
        !isSel && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, fontWeight: 600, color: T.accent } }, "Usar \u2192")
      );
    })(),
    ...
    }), w.off === 0 && adminSlots().filter((h) => !slotPast(w.off, h)).length === 0 && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 10, color: T.textFaint, padding: "8px 2px" } }, "Sin horas hoy")))))))
  );
}
