...
function DashboardView({ T, D, A, appts, patients, go }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: lux ? { maxWidth: 1180, margin: "0 auto" } : void 0 }, lux ? /* @__PURE__ */ React.createElement("div", { style: { margin: "2px 0 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), _greet, clinicDisplayName() ? ", " + clinicDisplayName() : ""), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: "clamp(26px, 3vw, 34px)", letterSpacing: "-.01em", color: T.text, marginTop: 10, lineHeight: 1.05, textTransform: "capitalize" } }, _fechaLarga), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")) : /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 300, fontSize: 28, letterSpacing: "-.02em", color: T.text, lineHeight: 1.1 } }, _greet, clinicDisplayName() ? ", " + clinicDisplayName().split(" ")[0] : "", "."), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 5 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: lux ? "flex-start" : "center", marginBottom: lux ? 18 : 22 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", gap: 4, background: T.surface, border: "1px solid " + T.line, borderRadius: 999, padding: 3 } }, TABS.map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTab(k), style: { fontFamily: T.sans, fontSize: lux ? 11.5 : 12.5, fontWeight: tab === k ? 600 : 500, padding: lux ? "7px 15px" : "8px 18px", borderRadius: 999, cursor: "pointer", border: "none", background: tab === k ? T.accent : "transparent", color: tab === k ? T.onAccent || "#fff" : T.textMute, transition: "all .18s " + T.ease } }, l)))), tab === "general" && lux && (() => {
    ...
    const kpiCard = (label, value, sub, ic, popup, cfmt, idx) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: label,
        onClick: () => popup && setKpiPopup(popup),
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: eyebrowLbl }, label), /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, width: 38, height: 38, borderRadius: 11, background: glassFill, border: "1px solid " + T.line, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(DashIcon, { name: ic, c: T.accent, size: 18 }))),
      /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 34, fontWeight: 400, color: T.text, lineHeight: 1.05, marginTop: 12 } }, /* @__PURE__ */ React.createElement(CountUp, { value, format: cfmt })),
      /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textFaint, marginTop: 5 } }, sub)
    );
    const blocks = {
      funnel: /* @__PURE__ */ React.createElement(FunnelBlock, null),
      indicadores: /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { ...eyebrowLbl, marginBottom: 12 } }, "Indicadores principales"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 } }, kpiCard("Pacientes totales", patients.length, "Pacientes activos", "pacientes", "pacientes", void 0, 0), kpiCard("Citas hoy", hoy.length, "Agendadas para hoy", "citas", "citas", void 0, 1), kpiCard("Nuevos pacientes", nuevosMes, "A\xF1adidos este mes", "nuevos", "nuevos", void 0, 2), kpiCard("Ingresos hoy", ingresosHoy, "Generado hoy", "ingresos", "ingresos", fmt, 3)))
    };
