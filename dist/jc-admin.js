...
function DashboardView({ T, D, A, appts, patients, go }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: lux ? { maxWidth: 1180, margin: "0 auto" } : void 0 }, lux ? /* @__PURE__ */ React.createElement("div", { style: { margin: "6px 0 26px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), _greet, clinicDisplayName() ? ", " + clinicDisplayName() : ""), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: "clamp(38px, 5vw, 56px)", letterSpacing: "-.02em", color: T.text, marginTop: 12, lineHeight: 1, textTransform: "capitalize" } }, _fechaLarga), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")) : /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 300, fontSize: 28, letterSpacing: "-.02em", color: T.text, lineHeight: 1.1 } }, _greet, clinicDisplayName() ? ", " + clinicDisplayName().split(" ")[0] : "", "."), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 5 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: lux ? "flex-start" : "center", marginBottom: lux ? 18 : 22 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", gap: 4, background: T.surface, border: "1px solid " + T.line, borderRadius: 999, padding: 3 } }, TABS.map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTab(k), style: { fontFamily: T.sans, fontSize: lux ? 11.5 : 12.5, fontWeight: tab === k ? 600 : 500, padding: lux ? "7px 15px" : "8px 18px", borderRadius: 999, cursor: "pointer", border: "none", background: tab === k ? T.accent : "transparent", color: tab === k ? T.onAccent || "#fff" : T.textMute, transition: "all .18s " + T.ease } }, l)))), tab === "general" && lux && (() => {
    ...
    const nowMarker = /* @__PURE__ */ React.createElement("div", { key: "now", style: { display: "flex", alignItems: "center", gap: 12, padding: "3px 4px" } }, /* @__PURE__ */ React.createElement("div", { style: { flexShrink: 0, width: 50, textAlign: "right", fontFamily: T.sans, fontSize: 10, fontWeight: 700, letterSpacing: ".04em", color: green } }, String(Math.floor(nowM / 60)).padStart(2, "0"), ":", String(nowM % 60).padStart(2, "0")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, height: 0, borderTop: "1.5px solid " + green, position: "relative" } }, /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: -2, top: -4, width: 8, height: 8, borderRadius: "50%", background: green } })));
    const dayRow = (a) => {
