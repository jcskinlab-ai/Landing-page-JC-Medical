...
function NewCitaModal({ T, patients, addPatient, time, day, onClose, onSave, prefill, appts, onOpenPatient }) {
  ...
  if (step === 2) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      })())) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 13 } }, /* @__PURE__ */ React.createElement(AdField, { T, label: "Nombre completo", value: nombre, onChange: setNombre, placeholder: "Ej: Paciente nuevo" }), /* @__PURE__ */ React.createElement(AdField, { T, label: "RUT", value: rut, onChange: (v) => setRut(window.jcmFmtRut ? window.jcmFmtRut(v) : v), placeholder: "12.345.678-9" }), /* @__PURE__ */ React.createElement(AdField, { T, label: "Tel\xE9fono m\xF3vil (WhatsApp)", value: phone, onChange: setPhone, inputMode: "tel" }), /* @__PURE__ */ React.createElement(AdField, { T, label: "Correo", value: email, onChange: setEmail, inputMode: "email", placeholder: "correo@ejemplo.com" })),
