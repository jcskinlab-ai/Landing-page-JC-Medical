...
function Agenda({ T, appts, patients, addAppt, addPatient, updateAppt, removeAppt, onOpenPatient, onSyncWeb, initialApptId, onConsumeApptId }) {
  ...
  return (
    ...
    /* @__PURE__ */ React.createElement("div", { style: luxF ? { maxWidth: 1560, margin: "0 auto" } : void 0 }, luxF && view !== "dia" && (() => {
      ...
      })), /* @__PURE__ */ React.createElement("button", { onClick: () => setDay(0), style: { width: "100%", marginTop: 12, padding: "9px", borderRadius: 9, border: "1px solid " + T.line, background: "transparent", color: T.textMute, fontFamily: T.sans, fontSize: 12.5, cursor: "pointer" } }, "Ir a hoy")), /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: secT }, "Informaci\xF3n del d\xEDa"), infoRow("Citas", list.length), infoRow("Duraci\xF3n total", fmtDur(dayTotalMin)), infoRow("Tiempo libre", fmtDur(dayFreeMin))));
...
function SemanaGrid({ T, week, appts, onNew, onEdit, updateAppt, removeAppt, onDay, onVerFicha, viewToggle, nuevaBtn, icsBtn }) {
  ...
  }))))), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textFaint, marginTop: 12 } }, "Pasa el mouse por un horario libre y toca el ", /* @__PURE__ */ React.createElement("b", { style: { color: T.accent } }, "+"), " para agendar \xB7 pasa el cursor por una cita para ver el detalle y acciones."));
  const weekSidebarBlock = !wkCardNew ? null : (() => {
    ...
    })), /* @__PURE__ */ React.createElement("button", { onClick: () => onDay(0), style: { width: "100%", marginTop: 12, padding: "9px", borderRadius: 9, border: "1px solid " + T.line, background: "transparent", color: T.textMute, fontFamily: T.sans, fontSize: 12.5, cursor: "pointer" } }, "Ir a hoy")), /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: secT }, "Informaci\xF3n del d\xEDa"), infoRow("Citas", todayList.length), infoRow("Duraci\xF3n total", fmtDur(todayTotalMin)), infoRow("Tiempo libre", fmtDur(todayFreeMin))));
  })();
  ...
  })(), wkCardNew ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 0", minWidth: 0 } }, weekGridBlock), weekSidebarBlock) : weekGridBlock, hover && hover.a && !menu && (() => {
