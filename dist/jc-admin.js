...
function Agenda({ T, appts, patients, addAppt, addPatient, updateAppt, removeAppt, onOpenPatient, onSyncWeb, initialApptId, onConsumeApptId }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, luxF && (() => {
    const heroShadow = T.dark ? "0 1px 14px rgba(0,0,0,.55)" : "0 1px 14px rgba(255,255,255,.7)";
    return /* @__PURE__ */ React.createElement("div", { style: { margin: "6px 0 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent, textShadow: heroShadow } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), "Agenda de la cl\xEDnica"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: "clamp(24px, 2.6vw, 30px)", letterSpacing: "-.01em", color: T.text, margin: "10px 0 0", lineHeight: 1.05, textShadow: heroShadow } }, "Reservas y Citas"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8, textShadow: heroShadow } }, (() => {
...
function SemanaGrid({ T, week, appts, onNew, onEdit, updateAppt, removeAppt, onDay, onVerFicha, viewToggle, nuevaBtn, icsBtn }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, (() => {
    const hoyBtn = /* @__PURE__ */ React.createElement("button", { onClick: () => setWkOff(0), style: { fontFamily: T.sans, fontSize: 12, fontWeight: 500, color: wkOff === 0 ? T.textMute : T.text, background: T.surface, border: "1px solid " + T.line, borderRadius: luxF ? DS.r.ctl : 9, padding: "8px 16px", cursor: "pointer" } }, "Hoy");
    ...
    const profNode = v2 && team.length > 0 ? /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setProfOpen((o) => !o), title: "Ver agenda de un profesional", style: { display: "flex", alignItems: "center", gap: 8, height: 34, padding: luxF ? "0 12px 0 5px" : "0 13px", border: "1px solid " + T.line, background: T.surface, borderRadius: luxF ? DS.r.pill : 9, color: T.text, fontFamily: T.sans, fontSize: 12.5, cursor: "pointer", maxWidth: 220 } }, luxF ? /* @__PURE__ */ React.createElement("span", { style: { width: 24, height: 24, borderRadius: "50%", background: selProfColor, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: T.sans, fontSize: 9.5, fontWeight: 700, flexShrink: 0 } }, profIni(selProf)) : /* @__PURE__ */ React.createElement("span", { style: { width: 9, height: 9, borderRadius: "50%", background: selProfColor, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, selProf || "Profesional"), /* @__PURE__ */ React.createElement("svg", { width: "11", height: "11", viewBox: "0 0 24 24", fill: "none", stroke: T.textFaint, strokeWidth: "2", style: { flexShrink: 0 } }, /* @__PURE__ */ React.createElement("path", { d: "M6 9l6 6 6-6" }))), profOpen && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { onClick: () => setProfOpen(false), style: { position: "fixed", inset: 0, zIndex: 60 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", right: 0, top: "calc(100% + 6px)", minWidth: 224, background: T.surface, border: "1px solid " + T.line, borderRadius: 10, boxShadow: T.shadow, overflow: "hidden", zIndex: 61 } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "9px 14px 6px", fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Agenda por profesional"), team.map((m) => {
      ...
      return /* @__PURE__ */ React.createElement("button", { key: m.id || m.name, onClick: () => {
        setSelProf(m.name);
        setProfOpen(false);
      }, style: { display: "flex", alignItems: "center", gap: 10, width: "100%", textAlign: "left", padding: "10px 14px", background: m.name === selProf ? T.accent + "14" : "transparent", border: "none", cursor: "pointer", fontFamily: T.sans, fontSize: 12.5, color: m.name === selProf ? T.accent : T.textMute } }, luxF ? /* @__PURE__ */ React.createElement("span", { style: { width: 24, height: 24, borderRadius: "50%", background: m.color || T.accent, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: T.sans, fontSize: 9.5, fontWeight: 700, flexShrink: 0 } }, profIni(m.name)) : /* @__PURE__ */ React.createElement("span", { style: { width: 9, height: 9, borderRadius: "50%", background: m.color || T.accent, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "block", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, m.name), showSuc && /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 10, color: T.textFaint, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginTop: 1 } }, sucs.join(" \xB7 "))), m.name === selProf && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10 } }, "\u2713"));
    })))) : null;
