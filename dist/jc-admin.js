...
function DashboardView({ T, D, A, appts, patients, go }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: lux ? { maxWidth: 1180, margin: "0 auto" } : void 0 }, lux ? /* @__PURE__ */ React.createElement("div", { style: { margin: "6px 0 26px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), _greet, clinicDisplayName() ? ", " + clinicDisplayName() : ""), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: 42, letterSpacing: "-.015em", color: T.text, marginTop: 12, lineHeight: 1.02, textTransform: "capitalize" } }, _fechaLarga), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")) : /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 300, fontSize: 28, letterSpacing: "-.02em", color: T.text, lineHeight: 1.1 } }, _greet, clinicDisplayName() ? ", " + clinicDisplayName().split(" ")[0] : "", "."), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 5 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: 22 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", gap: 4, background: T.surface, border: "1px solid " + T.line, borderRadius: 999, padding: 4 } }, TABS.map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTab(k), style: { fontFamily: T.sans, fontSize: 12.5, fontWeight: tab === k ? 600 : 500, padding: "8px 18px", borderRadius: 999, cursor: "pointer", border: "none", background: tab === k ? T.accent : "transparent", color: tab === k ? T.onAccent || "#fff" : T.textMute } }, l)))), tab === "general" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(FunnelBlock, null), (() => {
    const secHead = (t) => lux ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), t) : /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, letterSpacing: ".16em", textTransform: "uppercase", color: T.text, fontWeight: 600, marginBottom: 9 } }, t);
    return /* @__PURE__ */ React.createElement(React.Fragment, null, secHead("Indicadores Principales"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(" + (lux ? 210 : 190) + "px,1fr))", gap: lux ? 14 : 11, marginBottom: lux ? 22 : 14 } }, /* @__PURE__ */ React.createElement(Kpi, { ic: "pacientes", label: "Pacientes totales", value: patients.length, sub: "Pacientes activos", popup: "pacientes" }), /* @__PURE__ */ React.createElement(Kpi, { ic: "citas", label: "Citas hoy", value: hoy.length, sub: "Agendadas para hoy", popup: "citas" }), /* @__PURE__ */ React.createElement(Kpi, { ic: "nuevos", label: "Nuevos pacientes", value: nuevosMes, sub: "A\xF1adidos este mes", popup: "nuevos" }), /* @__PURE__ */ React.createElement(Kpi, { ic: "ingresos", label: "Ingresos hoy", value: fmt(ingresosHoy), sub: "Generado hoy", popup: "ingresos" })), /* @__PURE__ */ React.createElement("div", { style: lux ? { background: T.surface, border: "1px solid " + T.line, borderRadius: 16, padding: "20px 22px", marginBottom: 22, boxShadow: T.shadow } : { background: T.surface, border: "1px solid " + T.line, borderRadius: 12, padding: "13px 16px", marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 10, marginBottom: lux ? 12 : 8 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, !lux && /* @__PURE__ */ React.createElement("div", { style: { width: 32, height: 32, borderRadius: 9, background: T.accent + "14", display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M3 17l5-5 4 4 8-8M21 8h-4M21 8v4" }))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: lux ? 19 : 16, color: T.text } }, "Evoluci\xF3n de ingresos"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute, marginTop: lux ? 3 : 0 } }, "Estimado de la semana"))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: lux ? 26 : 22, color: T.text, lineHeight: 1 } }, fmt(totalSemana)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: green, marginTop: 3 } }, "\u2197 +", growth, "% en la semana"))), /* @__PURE__ */ React.createElement(Chart, null)), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: 18, alignItems: "start" } }, /* @__PURE__ */ React.createElement("div", null, secHead("Pr\xF3ximas 5 citas"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 9 } }, prox5.length ? prox5.map(citaRow) : /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textFaint, padding: "20px 0" } }, "No hay citas pr\xF3ximas."))), /* @__PURE__ */ React.createElement("div", null, secHead("Accesos r\xE1pidos"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 9 } }, acceso("crear", "Crear paciente", "A\xF1adir nueva ficha m\xE9dica", "pacientes"), acceso("cita", "Nueva cita", "Agendar una atenci\xF3n", "agenda"), acceso("puntos", "Otorgar puntos", "Programa de fidelidad", "fidelidad"), acceso("stock", "Inventario", "Stock e insumos", "inventario")))));
