...
function DashboardView({ T, D, A, appts, patients, go }) {
  ...
  const acceso = (ic, title, sub, to) => /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { width: 40, height: 40, borderRadius: 10, background: T.accent + "14", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement(DashIcon, { name: ic, c: T.accent })),
  ...
  return /* @__PURE__ */ React.createElement("div", { style: lux ? { maxWidth: 1180, margin: "0 auto" } : void 0 }, lux ? /* @__PURE__ */ React.createElement("div", { style: { margin: "6px 0 26px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".28em", textTransform: "uppercase", color: T.accent } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), _greet, clinicDisplayName() ? ", " + clinicDisplayName() : ""), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: 42, letterSpacing: "-.015em", color: T.text, marginTop: 12, lineHeight: 1.02, textTransform: "capitalize" } }, _fechaLarga), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 8 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")) : /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 300, fontSize: 28, letterSpacing: "-.02em", color: T.text, lineHeight: 1.1 } }, _greet, clinicDisplayName() ? ", " + clinicDisplayName().split(" ")[0] : "", "."), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginTop: 5 } }, hoy.length === 0 ? "No tienes citas para hoy." : "Tienes " + hoy.length + " cita" + (hoy.length === 1 ? "" : "s") + " hoy.", " ", ingresosHoy > 0 && "\xB7 " + fmt(ingresosHoy) + " en caja hoy.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: lux ? "flex-start" : "center", marginBottom: lux ? 18 : 22 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", gap: 4, background: T.surface, border: "1px solid " + T.line, borderRadius: 999, padding: 3 } }, TABS.map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTab(k), style: { fontFamily: T.sans, fontSize: lux ? 11.5 : 12.5, fontWeight: tab === k ? 600 : 500, padding: lux ? "7px 15px" : "8px 18px", borderRadius: 999, cursor: "pointer", border: "none", background: tab === k ? T.accent : "transparent", color: tab === k ? T.onAccent || "#fff" : T.textMute, transition: "all .18s " + T.ease } }, l)))), tab === "general" && lux && (() => {
    ...
    const rule = /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } });
    const rowLux = (a) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: a.id,
        onClick: () => go("agenda"),
      ...
      /* @__PURE__ */ React.createElement("div", { style: { flexShrink: 0, textAlign: "center", minWidth: 52 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 18, color: T.text, lineHeight: 1 } }, a.time || "\u2014"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 8, letterSpacing: ".14em", textTransform: "uppercase", color: T.accent, marginTop: 4 } }, apptDayOff(a) === 0 ? "Hoy" : a.when || "Pr\xF3x.")),
      /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, borderLeft: "1px solid " + T.line, paddingLeft: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13.5, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textMute, marginTop: 2 } }, a.proc || "\u2014", " \xB7 ", parseInt(a.dur, 10) || 60, " min")),
      /* @__PURE__ */ React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: T.textFaint, strokeWidth: "1.7", style: { flexShrink: 0 } }, /* @__PURE__ */ React.createElement("path", { d: "m9 18 6-6-6-6" }))
    );
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px,1fr))", gap: 14, marginBottom: 22 } }, /* @__PURE__ */ React.createElement(Kpi, { idx: 0, ic: "pacientes", label: "Pacientes totales", value: patients.length, sub: "Pacientes activos", popup: "pacientes" }), /* @__PURE__ */ React.createElement(Kpi, { idx: 1, ic: "citas", label: "Citas hoy", value: hoy.length, sub: "Agendadas para hoy", popup: "citas" }), /* @__PURE__ */ React.createElement(Kpi, { idx: 2, ic: "nuevos", label: "Nuevos pacientes", value: nuevosMes, sub: "A\xF1adidos este mes", popup: "nuevos" }), /* @__PURE__ */ React.createElement(Kpi, { idx: 3, ic: "ingresos", label: "Ingresos hoy", value: ingresosHoy, cfmt: fmt, sub: "Generado hoy", popup: "ingresos" })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 18, alignItems: "start" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 18, ...DS ? DS.reveal(4) : {} } }, /* @__PURE__ */ React.createElement(FunnelBlock, null)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 18, ...DS ? DS.reveal(5) : {} } }, /* @__PURE__ */ React.createElement("div", { style: { ...panel, padding: "20px 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 } }, /* @__PURE__ */ React.createElement("div", { style: eyebrow }, rule, " Pr\xF3ximas citas"), /* @__PURE__ */ React.createElement("button", { onClick: () => go("agenda"), style: { ...linkBtn(T), fontSize: 10 } }, "Ver agenda \u2192")), prox5.length ? prox5.map(rowLux) : /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textFaint, padding: "14px 0" } }, "No hay citas pr\xF3ximas. Agenda la primera desde el bot\xF3n Nueva cita.")), /* @__PURE__ */ React.createElement("div", { style: { ...panel, padding: "20px 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 10, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: eyebrow }, rule, " Evoluci\xF3n de ingresos"), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 24, color: T.text, lineHeight: 1 } }, fmt(totalSemana)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: green, marginTop: 3 } }, "\u2197 +", growth, "% en la semana"))), /* @__PURE__ */ React.createElement(Chart, null)), /* @__PURE__ */ React.createElement("div", { style: { ...panel, padding: "20px 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { ...eyebrow, marginBottom: 12 } }, rule, " Accesos r\xE1pidos"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 9 } }, acceso("crear", "Crear paciente", "A\xF1adir nueva ficha m\xE9dica", "pacientes"), acceso("cita", "Nueva cita", "Agendar una atenci\xF3n", "agenda"), acceso("puntos", "Otorgar puntos", "Programa de fidelidad", "fidelidad"), acceso("stock", "Inventario", "Stock e insumos", "inventario"))))));
...
function AdminApp() {
  ...
  useEffect(() => {
    try {
      ...
      var ok = adminNavItems().some(function(n) {
        return n.k === section;
      }) || section === "pacientes";
