...
function WaGlyph() {
  return /* @__PURE__ */ React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M21 11.5a8.5 8.5 0 0 1-12.5 7.5L3 20l1-5A8.5 8.5 0 1 1 21 11.5z" }));
}
function DentalPlanBlock({ T, S, data }) {
  ...
  function waLink(proc) {
    return "https://wa.me/" + whats + "?text=" + encodeURIComponent(
      "Hola, soy " + (data && data.name || "") + ". Me gustar\xEDa agendar mi tratamiento de " + proc + "."
    );
  }
  ...
  return /* @__PURE__ */ React.createElement("div", null, pend.length > 0 && /* @__PURE__ */ React.createElement("div", { style: S.secLabel }, "Mis tratamientos pendientes (", pend.length, ")"), next && /* @__PURE__ */ React.createElement("div", { style: S.planNext }, /* @__PURE__ */ React.createElement("div", { style: S.planNextLabel }, "Tu pr\xF3ximo paso"), /* @__PURE__ */ React.createElement("div", { style: S.planNextMain }, next.proc), /* @__PURE__ */ React.createElement("div", { style: { ...S.planPrio, color: PLAN_PRIO_COLOR[next.prioridad] || T.textMute } }, PLAN_PRIO_LABEL[next.prioridad] || "Prioridad media", next.estado === "encurso" ? " \xB7 en curso" : ""), whats && /* @__PURE__ */ React.createElement("a", { href: waLink(next.proc), target: "_blank", rel: "noopener", style: S.histWa }, /* @__PURE__ */ React.createElement(WaGlyph, null), "Agendar ", next.proc)), resto.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginTop: 10 } }, resto.map((it, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: S.planItem }, /* @__PURE__ */ React.createElement("span", { style: S.planItemProc }, it.proc), /* @__PURE__ */ React.createElement("span", { style: { ...S.planItemPrio, color: PLAN_PRIO_COLOR[it.prioridad] || T.textMute } }, it.estado === "encurso" ? "En curso" : function(s) {
    return s.charAt(0).toUpperCase() + s.slice(1);
  }((PLAN_PRIO_LABEL[it.prioridad] || "Prioridad media").replace("Prioridad ", "")))))), prof && prof.proxima && /* @__PURE__ */ React.createElement("div", { style: S.profBox }, /* @__PURE__ */ React.createElement("div", { style: S.planNextLabel }, "Tu pr\xF3xima limpieza"), /* @__PURE__ */ React.createElement("div", { style: S.planNextMain }, fmtFecha(prof.proxima)), prof.ultima && /* @__PURE__ */ React.createElement("div", { style: S.nextSub }, "Tu \xFAltima limpieza fue el ", fmtFecha(prof.ultima), "."), whats && /* @__PURE__ */ React.createElement("a", { href: waLink("limpieza dental"), target: "_blank", rel: "noopener", style: S.histWa }, /* @__PURE__ */ React.createElement(WaGlyph, null), "Agendar mi limpieza")));
}
