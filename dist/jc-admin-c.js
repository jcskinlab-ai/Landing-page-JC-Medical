...
function AutomatizacionesView({ T }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Automatizaciones", sub: "Configura recordatorios y mensajes autom\xE1ticos para tus pacientes." }), /* @__PURE__ */ React.createElement("div", { style: { background: T.accentSoft || "rgba(84,112,127,.12)", border: "1px solid " + T.line, borderRadius: 8, padding: "10px 14px", marginBottom: 16, fontFamily: T.sans, fontSize: 11.5, color: T.textMute } }, "El env\xEDo real de WhatsApp/Email/SMS se ejecuta desde el servidor (Medique). Aqu\xED configuras y visualizas las reglas."), /* @__PURE__ */ React.createElement(NotificacionesCard, { T }), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 17, color: T.text, marginBottom: 10 } }, "Recordatorios autom\xE1ticos"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 14 } }, rules.map((r) => {
