...
function RecitaPlazoCard({ T }) {
  ...
  function save() {
    ...
    try {
      DB2.set("config", Object.assign({}, DB2.cfg(), patch));
      setSaved(true);
      setTimeout(() => setSaved(false), 1800);
      window.jcmToast && window.jcmToast("Plazos de re-cita guardados.", "ok");
    } catch (e) {
    }
  }
  const DS = window.JCDS, luxF = DS && (typeof jcdsLux === "function" ? jcdsLux() : false);
  ...
  const row = (label, val, set, def, suf = "meses") => /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", marginBottom: 9 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontFamily: T.sans, fontSize: 12.5, color: T.text } }, label), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: 140, flexShrink: 0 } }, /* @__PURE__ */ React.createElement("input", { value: val, onChange: (e) => set(e.target.value.replace(/[^\d.]/g, "")), placeholder: "Ej. " + def, style: inp }), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", right: 11, top: "50%", transform: "translateY(-50%)", fontFamily: T.sans, fontSize: 11.5, color: T.textFaint, pointerEvents: "none" } }, suf)));
  return /* @__PURE__ */ React.createElement("div", { style: luxF ? { ...DS.card(T), padding: "18px 20px", marginBottom: 14 } : { background: T.surface, border: "1px solid " + T.line, borderRadius: 12, padding: "18px 18px", marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 18, color: T.text, display: "flex", alignItems: "center", gap: 8, marginBottom: 5 } }, /* @__PURE__ */ React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "9" }), /* @__PURE__ */ React.createElement("path", { d: "M12 7v5l3 2" })), "Campa\xF1a re-cita \xB7 Plazos de recontacto"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute, marginBottom: 14, lineHeight: 1.5 } }, "Define a los cu\xE1ntos meses desde la \xFAltima sesi\xF3n un paciente aparece listo para recontactar en la campa\xF1a de re-cita, y cu\xE1ntas sesiones tiene el esquema de Sculptra. Si dejas un campo vac\xEDo, se usa el valor por defecto."), row("\u{1F489} Toxina botul\xEDnica", tox, setTox, 3), row("\u{1F9EC} Sculptra / bioestimulador", scu, setScu, 2), row("\u{1F443} Rinomodelaci\xF3n / relleno", rin, setRin, 10), /* @__PURE__ */ React.createElement("div", { style: { height: 1, background: T.line, margin: "6px 0 11px" } }), row("\u{1F9EC} Sculptra \xB7 sesiones del esquema", scuTope, setScuTope, 3, "sesiones"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", marginTop: 4 } }, /* @__PURE__ */ React.createElement("button", { onClick: save, style: { padding: "9px 18px", borderRadius: 8, border: "none", background: T.accent, color: T.onAccent, fontFamily: T.sans, fontSize: 12, fontWeight: 600, cursor: "pointer" } }, saved ? "\u2713 Guardado" : "Guardar")));
}
...
const FICHA_FACE_POS = { "Frente": [100, 53], "Entrecejo": [100, 84], "Patas de gallo": [148, 98], "Ojeras": [122, 112], "P\xF3mulos": [138, 126], "Surcos nasogenianos": [118, 140], "C\xF3digo de barras": [100, 152], "Labios": [100, 164], "Ment\xF3n": [100, 182], "L\xEDnea mandibular": [58, 166], "Cuello": [100, 212] };
const FICHA_BODY_POS = { "Papada": [82, 48], "Espalda": [82, 84], "Brazos": [40, 108], "Flancos": [58, 116], "Abdomen": [82, 118], "Gl\xFAteos": [90, 148], "Dorso de manos": [30, 160], "Muslos": [66, 188], "Rodillas": [72, 214], "Pantorrillas": [72, 244] };
function FichaZoneMap({ T, kind, active, onToggle }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: 14 } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 " + vw + " " + vh, style: { width: facial ? 170 : 130, maxWidth: "100%", height: "auto" } }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("clipPath", { id: cid }, /* @__PURE__ */ React.createElement("rect", { width: vw, height: vh, rx: "16" }))), /* @__PURE__ */ React.createElement("image", { href: img, xlinkHref: img, x: "0", y: "0", width: vw, height: vh, preserveAspectRatio: "xMidYMid slice", clipPath: "url(#" + cid + ")" }), /* @__PURE__ */ React.createElement("rect", { width: vw, height: vh, rx: "16", fill: "none", stroke: T.line, strokeWidth: "1.5" }), Object.keys(pos).map((z) => {
    const p = pos[z];
    const on = active(z);
    return /* @__PURE__ */ React.createElement("g", { key: z, style: { cursor: "pointer" }, onClick: () => onToggle(z) }, /* @__PURE__ */ React.createElement("circle", { cx: p[0], cy: p[1], r: "8.5", fill: on ? T.accent : "rgba(12,16,22,.7)", stroke: on ? T.accent : "rgba(255,255,255,.85)", strokeWidth: "1.5" }), on && /* @__PURE__ */ React.createElement("path", { d: "M" + (p[0] - 3.5) + " " + p[1] + "l2.5 2.5 4.5 -5", fill: "none", stroke: T.onAccent || "#fff", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ React.createElement("title", null, z));
  })));
}
...
function SecHead({ T, title, sub }) {
  ...
  if (lux) return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: DS.sp[6] } }, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: DS.ft.display, letterSpacing: "-.01em", color: T.text, lineHeight: 1.05, textShadow: heroShadow } }, title), sub && /* @__PURE__ */ React.createElement("div", { style: { ...DS.text(T, "sub"), marginTop: 8, textShadow: heroShadow } }, sub));
...
function SalaEsperaView({ T, appts, patients, updatePatient }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Sala de espera", sub: "Pacientes de hoy, " + today + ". Actualiza el estado a medida que llegan y se atienden." }), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 } }, WAIT_COLS.map(([k, l]) => {
    ...
    const cc = colOf(k);
    return /* @__PURE__ */ React.createElement("div", { key: k, style: luxF ? { ...DS.card(T), padding: 12, minHeight: 200 } : { background: T.surface, border: "1px solid " + T.line, borderRadius: 10, padding: 12, minHeight: 200 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 7, fontFamily: T.sans, fontSize: 11, letterSpacing: ".12em", textTransform: "uppercase", color: cc } }, /* @__PURE__ */ React.createElement("span", { style: { width: 7, height: 7, borderRadius: "50%", background: cc, flexShrink: 0 } }), l), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.serif, fontSize: 16, color: items.length ? cc : T.textFaint } }, items.length)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, items.map((a) => /* @__PURE__ */ React.createElement("div", { key: a.id, style: luxF ? { background: T.bg, border: "1px solid " + T.line, borderRadius: DS.r.ctl, padding: "10px 12px" } : { background: T.bg, border: "1px solid " + T.line, borderRadius: 8, padding: "10px 12px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", gap: 9 } }, /* @__PURE__ */ React.createElement(Avatar, { T, name: a.name, size: 30 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { width: 6, height: 6, borderRadius: "50%", background: cc, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textMute, marginTop: 1 } }, a.time, a.proc ? " \xB7 " + a.proc : "")), /* @__PURE__ */ React.createElement("button", { onClick: () => eliminarDeSala(a), title: "Quitar de sala de espera", style: { flexShrink: 0, background: "none", border: "none", cursor: "pointer", color: T.textFaint, padding: "2px 3px", display: "flex", borderRadius: 4, marginTop: -1 } }, /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" }, /* @__PURE__ */ React.createElement("path", { d: "M18 6 6 18M6 6l12 12" })))), next(k) && /* @__PURE__ */ React.createElement("button", { onClick: () => setS(a.id, next(k)), style: { marginTop: 8, width: "100%", fontFamily: T.sans, fontSize: 10.5, letterSpacing: ".08em", textTransform: "uppercase", color: cc, background: cc + "1c", border: "none", borderRadius: 6, padding: "7px", cursor: "pointer" } }, lbl[k], " \u2192"))), !items.length && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textFaint, fontStyle: "italic", padding: "6px 2px" } }, "Sin pacientes")));
  })));
}
const AUTO_SEED = [
...
function patientsChangedExternally() {
  cashNotify();
  try {
    window.dispatchEvent(new CustomEvent("jcsaas:data", { detail: {} }));
  } catch (e) {
  }
}
...
function CajaView({ T }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 12, marginBottom: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Registro de Ventas", sub: ventasCount + " venta" + (ventasCount === 1 ? "" : "s") + " " + periodoLbl }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 9, marginTop: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute } }, fechaTxt.charAt(0).toUpperCase() + fechaTxt.slice(1)), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 10.5, fontWeight: 600, padding: "3px 10px", borderRadius: 999, whiteSpace: "nowrap", color: dayIsOpenVentas ? "#16A34A" : "#C0285A", background: (dayIsOpenVentas ? "#16A34A" : "#C0285A") + "18" } }, dayIsOpenVentas ? "D\xEDa abierto" : "D\xEDa cerrado"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setCierre(true), title: "Cierre del d\xEDa", style: { width: 38, height: 38, borderRadius: 9, border: "1px solid " + T.line, background: T.surface, color: T.textMute, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 9h18M9 14l2 2 4-4" }))), /* @__PURE__ */ React.createElement(AdBtn, { T, primary: true, onClick: () => setMov(true) }, "+ Movimiento"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" } }, chip("hoy", "Hoy"), chip("semana", "Esta semana"), chip("mes", "Este mes")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12, marginBottom: 18 } }, ventaKpis.map((k) => /* @__PURE__ */ React.createElement("div", { key: k.l, style: kpiCardV }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 34, height: 34, borderRadius: 9, background: k.c + "1c", color: k.c, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, k.icon)), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10, letterSpacing: ".08em", textTransform: "uppercase", color: T.textMute, whiteSpace: "nowrap" } }, k.l), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 21, color: T.text, lineHeight: 1.2 } }, k.v))), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute, marginTop: 8 } }, k.sub), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 0, right: 0, bottom: 0, height: 3, background: k.c } })))), /* @__PURE__ */ React.createElement(ProyeccionVentasIA, { T }), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "minmax(0,2fr) minmax(240px,1fr)", gap: 16, alignItems: "start", marginBottom: 2 } }, /* @__PURE__ */ React.createElement(FlujoCajaChart, { T }), /* @__PURE__ */ React.createElement("div", { style: luxF ? { ...DS.card(T), padding: "18px 20px" } : { background: T.surface, border: "1px solid " + T.line, borderRadius: 10, padding: "16px 18px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13, fontWeight: 600, color: T.text } }, "Tratamientos que m\xE1s venden"), /* @__PURE__ */ React.createElement("select", { value: tratScope, onChange: (e) => setTratScope(e.target.value), style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute, background: "none", border: "1px solid " + T.line, borderRadius: 7, padding: "3px 6px" } }, /* @__PURE__ */ React.createElement("option", { value: "mes" }, "Este mes"), /* @__PURE__ */ React.createElement("option", { value: "hist" }, "Hist\xF3rico"))), topTrat.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: T.textFaint } }, "A\xFAn no hay ventas ", tratScope === "mes" ? "este mes" : "registradas", ". Aparecer\xE1 cuando cobres atenciones desde la ficha del paciente."), topTrat.slice(0, showAllTrat ? topTrat.length : 1).map((t, i) => {
    ...
    return /* @__PURE__ */ React.createElement(CierreModal, { T, ingresos: iHoy, egresos: eHoy, costoIns: cHoy, neto: nHoy, fecha: fechaTxt, dia: hoyDay, onClose: () => setCierre(false) });
  })(), editMov && /* @__PURE__ */ React.createElement(MetodoPagoModal, { T, mov: editMov, onClose: () => setEditMov(null), onSave: (metodo) => {
...
function CierreModal({ T, ingresos, egresos, costoIns, neto, fecha, dia, onClose }) {
  ...
  function confirmarCierre() {
    try {
      ...
      restantes.unshift({ fecha, dia, ingresos, egresos, costoIns, neto, ts: (/* @__PURE__ */ new Date()).toISOString() });
...
function ProyeccionVentasIA({ T }) {
  ...
  for (let i = 5; i >= 1; i--) {
    ...
    hist.push({ key: _localDay(d).slice(0, 7), lbl: MESL[d.getMonth()], ing: ingDe(_localDay(d).slice(0, 7)) });
  }
  ...
  const proy = Math.round(ritmoDia * diasMes);
  ...
  try {
    ...
    citasRest = (window.DB && DB.get("appointments") || []).filter((a) => {
      const f = a.fecha || "";
      return f.slice(0, 7) === curKey && f >= hoyISO && a.status !== "anulada" && a.status !== "cancelada" && !a.attended && a.status !== "atendida";
    }).length;
  } catch (e) {
  }
  ...
  function analizar() {
    if (busy) return;
    if (!window.mediqueAI) {
      setErr("La IA no est\xE1 disponible en este servidor.");
      return;
    }
    setBusy(true);
    setErr("");
    ...
    const porTrat = {};
    cash.filter((x) => keyOf(x) === curKey && x.kind === "atencion" && x.type !== "egreso").forEach((x) => {
      const k = (x.concept || "").split("\xB7")[0].trim() || "Sin especificar";
      porTrat[k] = (porTrat[k] || 0) + (x.amount || 0);
    });
    const top = Object.keys(porTrat).map((k) => k + ": " + D.fmt(porTrat[k])).sort().slice(0, 6).join(" | ") || "sin ventas a\xFAn";
    const histTxt = hist.map((h) => h.lbl + " " + D.fmt(h.ing)).join(" | ");
    const datos = [
      "Cl\xEDnica de medicina est\xE9tica en Chile (moneda CLP).",
      "Ingresos de los 5 meses anteriores: " + histTxt + ".",
      "Mes en curso: lleva " + D.fmt(ingMes) + " en " + diaHoy + " de " + diasMes + " d\xEDas (" + ventasMes + " ventas, ticket promedio " + D.fmt(ticket) + ").",
      "Proyecci\xF3n de cierre calculada al ritmo actual: " + D.fmt(proy) + (deltaAnt != null ? " (" + (deltaAnt >= 0 ? "+" : "") + deltaAnt + "% vs el mes anterior)" : "") + ".",
      "Promedio de los meses anteriores: " + D.fmt(promHist) + ".",
      "Quedan " + diasRest + (diasRest === 1 ? " d\xEDa" : " d\xEDas") + " y hay " + citasRest + (citasRest === 1 ? " cita ya agendada" : " citas ya agendadas") + " por atender este mes.",
      "Tratamientos que m\xE1s facturan este mes: " + top + "."
    ].join("\n");
    const system = "Eres un analista de negocio para cl\xEDnicas de medicina est\xE9tica en Chile. Te dan cifras YA CALCULADAS: no las recalcules ni inventes otras, \xFAsalas tal cual. Responde en espa\xF1ol de Chile, directo y sin adornos, en m\xE1ximo 220 palabras, con esta estructura exacta:\nLECTURA: dos o tres frases interpretando la proyecci\xF3n (\xBFva bien, va corto, de qu\xE9 depende?).\nACCIONES: 4 vi\xF1etas para AUMENTAR INGRESOS este mes, cada una concreta y accionable con la agenda y los tratamientos que te dieron (nada gen\xE9rico tipo 'mejorar el marketing').\nCAPTACI\xD3N: 2 vi\xF1etas para atraer pacientes nuevos.\nNo prometas resultados garantizados ni des consejos m\xE9dicos. No uses markdown ni asteriscos.";
    window.mediqueAI([{ role: "user", content: datos }], clinic, { system, max_tokens: 700 }).then(function(r) {
      setBusy(false);
      if (r && r.ok && r.reply) setOut(r.reply);
      else if (r && r.configured === false) setErr("La IA no est\xE1 configurada en el servidor (falta GROQ_API_KEY).");
      else setErr(r && r.error || "La IA no respondi\xF3. Intenta de nuevo.");
    }).catch(function() {
      setBusy(false);
      setErr("No se pudo contactar la IA.");
    });
  }
  ...
  return /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 600, color: T.text } }, "Proyecci\xF3n del mes"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textFaint, marginTop: 2 } }, "Al ritmo de ", D.fmt(Math.round(ritmoDia)), " por d\xEDa \xB7 quedan ", diasRest, " d\xEDa", diasRest === 1 ? "" : "s")), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: analizar,
      disabled: busy || sinHistorial,
      title: sinHistorial ? "A\xFAn no hay ventas registradas para analizar" : "Analizar con IA",
      style: { display: "inline-flex", alignItems: "center", gap: 7, height: 34, padding: "0 14px", borderRadius: luxF ? DS.r.ctl : 8, border: "1px solid " + T.accent, background: busy ? "transparent" : T.accent, color: busy ? T.accent : T.onAccent || "#fff", fontFamily: T.sans, fontSize: 12, fontWeight: 600, cursor: busy || sinHistorial ? "not-allowed" : "pointer", opacity: sinHistorial ? 0.5 : 1 }
    },
    /* @__PURE__ */ React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7" }, /* @__PURE__ */ React.createElement("rect", { x: "4.5", y: "8", width: "15", height: "10", rx: "3" }), /* @__PURE__ */ React.createElement("path", { d: "M12 4.5V8" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "3.4", r: "1.3" })),
    busy ? "Analizando\u2026" : out ? "Volver a analizar" : "Analizar con IA"
  )), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: 14, flexWrap: "wrap", marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 32, color: T.text, lineHeight: 1.05 } }, D.fmt(proy)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute, marginTop: 3 } }, "cierre estimado de ", MESL[now.getMonth()])), deltaAnt != null && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 600, color: deltaCol, paddingBottom: 4 } }, deltaAnt >= 0 ? "\u25B2 " : "\u25BC ", Math.abs(deltaAnt), "% ", /* @__PURE__ */ React.createElement("span", { style: { color: T.textFaint, fontWeight: 400 } }, "vs mes anterior"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 18, flexWrap: "wrap", marginBottom: 14 } }, [["Van este mes", D.fmt(ingMes)], ["Ventas", String(ventasMes)], ["Ticket promedio", D.fmt(ticket)], ["Citas por atender", String(citasRest)], ["Promedio meses previos", D.fmt(promHist)]].map(([l, v]) => /* @__PURE__ */ React.createElement("div", { key: l }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13, fontWeight: 600, color: T.text } }, v), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10, color: T.textFaint, marginTop: 1 } }, l)))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: 10, height: 82, marginBottom: 4 } }, hist.concat([{ key: "proy", lbl: MESL[now.getMonth()], ing: proy, esProy: true }]).map((m) => /* @__PURE__ */ React.createElement("div", { key: m.key, title: (m.esProy ? "Proyectado: " : "") + D.fmt(m.ing), style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 5 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, width: "100%", display: "flex", alignItems: "flex-end", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("div", { style: {
    width: "62%",
    height: Math.round(m.ing / maxBar * 58) + "px",
    minHeight: 2,
    borderRadius: "4px 4px 0 0",
    background: m.esProy ? "transparent" : T.accent,
    border: m.esProy ? "1.5px dashed " + T.accent : "none",
    opacity: m.esProy ? 1 : 0.75
  } })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9.5, color: m.esProy ? T.accent : T.textFaint, fontWeight: m.esProy ? 600 : 400 } }, m.lbl)))), err && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: "#C0285A", marginTop: 10 } }, err), sinHistorial && !err && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute, marginTop: 10 } }, "A\xFAn no hay ventas registradas: la proyecci\xF3n aparecer\xE1 cuando empieces a cobrar atenciones."), out && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 14, paddingTop: 13, borderTop: "1px solid " + T.line } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10, letterSpacing: ".18em", textTransform: "uppercase", color: T.accent, marginBottom: 8 } }, "An\xE1lisis y recomendaciones \xB7 IA"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.text, lineHeight: 1.65, whiteSpace: "pre-wrap" } }, out)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 9.5, color: T.textFaint, marginTop: 12, lineHeight: 1.5 } }, "La cifra se calcula con tus ingresos reales (ritmo del mes e historial), no la genera la IA. Es una estimaci\xF3n: cambia seg\xFAn lo que cobres los d\xEDas que quedan."));
}
