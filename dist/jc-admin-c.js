...
function PendientesView({ T, patients, appts, go, openP, updatePatient, goApt }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Pendientes", sub: "Seguimientos cl\xEDnicos y control de calidad." }), /* @__PURE__ */ React.createElement(ContraloriaView, { T, patients, appts, openP, goApt, go, embed: true }), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 26 } }, /* @__PURE__ */ React.createElement(Group, { T, title: "Re-citar \xB7 esquema en curso (" + recitas.length + ")" }, (showAllReci ? recitas : recitas.slice(0, 2)).map(({ p, r }) => /* @__PURE__ */ React.createElement(PendRow, { key: p.id, T, name: p.name, desc: r.motivo + " \xB7 " + r.precioFmt + " \u2192 " + r.descFmt, action: "WhatsApp", href: window.recitaWa ? window.recitaWa(p, r) : "https://wa.me/" + (p.phone || "").replace(/\D/g, "") })), !recitas.length && /* @__PURE__ */ React.createElement(Empty2, { T }, "Sin re-citas por contactar hoy."), recitas.length > 2 && /* @__PURE__ */ React.createElement("button", { onClick: () => setShowAllReci((v) => !v), style: { alignSelf: "flex-start", display: "inline-flex", alignItems: "center", gap: 7, fontFamily: T.sans, fontSize: 11.5, fontWeight: 600, color: T.accent, background: "none", border: "1px dashed " + T.line, borderRadius: 8, padding: "8px 13px", cursor: "pointer", marginTop: 2 } }, /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.2", style: { transform: showAllReci ? "rotate(180deg)" : "none", transition: "transform .2s" } }, /* @__PURE__ */ React.createElement("path", { d: "M6 9l6 6 6-6" })), showAllReci ? "Ver menos" : "Ver " + (recitas.length - 2) + " re-cita" + (recitas.length - 2 === 1 ? "" : "s") + " m\xE1s")), /* @__PURE__ */ React.createElement(Group, { T, title: "Consentimientos por renovar \xB7 +1 a\xF1o (" + porRenovar.length + ")" }, porRenovar.map((p) => {
