...
function EspecialidadesTab({ T }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute, marginBottom: 14, lineHeight: 1.5 } }, "Define las especialidades que ofrece tu cl\xEDnica. Se asignan a cada profesional en su ficha (secci\xF3n Especialidades)."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 18 } }, /* @__PURE__ */ React.createElement("input", { value: nueva, onChange: (e) => setNueva(e.target.value), onKeyDown: (e) => {
    if (e.key === "Enter") {
      e.preventDefault();
      add();
    }
  }, placeholder: "Nueva especialidad\u2026", style: { flex: 1, minWidth: 0, padding: "12px 14px", borderRadius: 8, border: "1px solid " + T.line, background: T.surface, color: T.text, fontFamily: T.sans, fontSize: 13, outline: "none", boxSizing: "border-box" } }), /* @__PURE__ */ React.createElement(AdBtn, { T, primary: true, onClick: add }, "+ Agregar")), list.length === 0 ? /* @__PURE__ */ React.createElement(Empty2, { T }, "A\xFAn no hay especialidades. Agrega la primera arriba.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5 } }, list.map((e) => {
    const n = profCount(e);
...
const PROF_ESPECIALIDADES = ["Medicina est\xE9tica", "Toxina botul\xEDnica", "\xC1cido hialur\xF3nico", "Bioestimuladores", "Mesoterapia", "Hilos tensores", "Peelings", "Cosmiatr\xEDa", "Dermatolog\xEDa", "Nutrici\xF3n", "Kinesiolog\xEDa est\xE9tica", "Enfermer\xEDa"];
...
function ProfesionalForm({ T, member, onClose, onSave }) {
  const [f, setF] = useState(() => member ? { ...member, perms: member.perms || {}, especialidades: member.especialidades || (member.role ? [member.role] : []), tratamientos: member.tratamientos || [], sucursales: member.sucursales || [] } : { name: "", role: "", email: "", phone: "+56 9 ", active: true, access: false, perms: {}, especialidades: [], tratamientos: [], sucursales: [] });
