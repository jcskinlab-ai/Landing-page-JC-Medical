...
function AutomatizacionesView({ T }) {
  ...
  })), editAuto && /* @__PURE__ */ React.createElement(AutoBuilderModal, { T, auto: editAuto === "new" ? null : editAuto, onClose: () => setEditAuto(null), onSave: saveAuto }));
}
