      ...
      return /* @__PURE__ */ React.createElement("div", { key: group.cat, style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textMute, marginBottom: 7, paddingLeft: 2 } }, SVC_CAT_LABEL[group.cat] || group.cat), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5 } }, gi.map((it, i) => {
        ...
        return /* @__PURE__ */ React.createElement(
          "div",
          {
            ...
            style: luxF ? { ...DS.card(T), display: "flex", alignItems: "center", gap: 10, padding: "12px 15px", cursor: "pointer", borderColor: hover === hk ? T.accent + "88" : T.line, transition: DS.trans("border-color") } : { display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderRadius: 8, background: T.surface, border: "1px solid " + (hover === hk ? T.accent : T.line), cursor: "pointer", transition: "border-color .15s" }
          },
...
function EquipoView({ T }) {
  ...
  const DS = window.JCDS, luxF = DS && (typeof jcdsLux === "function" ? jcdsLux() : false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Equipo", sub: "Profesionales y permisos" }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, team.map((t, i) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: t.id,
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 7, flexShrink: 0 } }, /* @__PURE__ */ React.createElement(AdTag, { T, tone: t.active ? "ok" : "muted" }, t.active ? "Activo" : "Inactivo"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".12em", textTransform: "uppercase", color: T.accent } }, "Editar \u2192"))
...
function SecHead({ T, title, sub }) {
  ...
  if (lux) return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: DS.sp[6] } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 26, height: 1, background: T.gold || T.accent } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: DS.ft.eyebrow, fontWeight: 500, letterSpacing: ".18em", textTransform: "uppercase", color: T.accent } }, "Medique")), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: T.serif, fontWeight: 400, fontSize: DS.ft.display, letterSpacing: "-.01em", color: T.text, lineHeight: 1.05 } }, title), sub && /* @__PURE__ */ React.createElement("div", { style: { ...DS.text(T, "sub"), marginTop: 8 } }, sub));
...
function PendientesView({ T, patients, appts, go, openP, updatePatient }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Pendientes", sub: "Tareas generales del equipo y seguimientos cl\xEDnicos." }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 16 } }, /* @__PURE__ */ React.createElement("input", { value: draft, onChange: (e) => setDraft(e.target.value), onKeyDown: (e) => e.key === "Enter" && addTask(), placeholder: "Nuevo pendiente\u2026", style: { flex: 1, fontFamily: T.sans, fontSize: 13, padding: "11px 14px", borderRadius: 8, border: "1px solid " + T.line, background: T.surface, color: T.text, outline: "none" } }), /* @__PURE__ */ React.createElement("button", { onClick: addTask, style: { fontFamily: T.sans, fontSize: 12, fontWeight: 600, color: T.onAccent || "#fff", background: T.accent, border: "none", borderRadius: 8, padding: "0 18px", cursor: "pointer", whiteSpace: "nowrap" } }, "+ Agregar")), (() => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 22 } }, /* @__PURE__ */ React.createElement("div", { style: panel }, /* @__PURE__ */ React.createElement("div", { style: { ...heading, marginBottom: 10 } }, "Pendientes (", totalPend, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tPend.length ? tPend.map(taskCard) : otrosPend > 0 ? /* @__PURE__ */ React.createElement(Empty2, { T }, "Sin tareas manuales. Abajo tienes ", sinConsent.length, " consentimiento(s) y ", recitas.length, " re-cita(s) por gestionar.") : /* @__PURE__ */ React.createElement(Empty2, { T }, "Nada pendiente. \u{1F389}"))), /* @__PURE__ */ React.createElement("div", { style: panel }, /* @__PURE__ */ React.createElement("div", { style: { ...heading, marginBottom: 10 } }, "Completadas (", tDone.length, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, tDone.length ? tDone.map(taskCard) : /* @__PURE__ */ React.createElement(Empty2, { T }, "A\xFAn nada completado."))));
  })(), /* @__PURE__ */ React.createElement(Group, { T, title: "Consentimientos por firmar (" + sinConsent.length + ")" }, sinConsent.map((p) => /* @__PURE__ */ React.createElement(PendRow, { key: p.id, T, name: p.name, desc: p.tags && p.tags[0] || "Paciente", action: "Ir a consentimientos", onClick: () => openP(p.id, "consent"), onDelete: () => updatePatient(p.id, { consent: true, consentInfo: "Marcado como firmado", consentTs: Date.now() }) })), !sinConsent.length && /* @__PURE__ */ React.createElement(Empty2, { T }, "Todo firmado.")), /* @__PURE__ */ React.createElement(Group, { T, title: "Consentimientos por renovar \xB7 +1 a\xF1o (" + porRenovar.length + ")" }, porRenovar.map((p) => {
...
function AutomatizacionesView({ T }) {
  ...
  const DS = window.JCDS, luxF = DS && (typeof jcdsLux === "function" ? jcdsLux() : false);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Automatizaciones", sub: "Configura recordatorios y mensajes autom\xE1ticos para tus pacientes." }), /* @__PURE__ */ React.createElement("div", { style: { background: T.accentSoft || "rgba(84,112,127,.12)", border: "1px solid " + T.line, borderRadius: 8, padding: "10px 14px", marginBottom: 16, fontFamily: T.sans, fontSize: 11.5, color: T.textMute } }, "El env\xEDo real de WhatsApp/Email/SMS se ejecuta desde el servidor (Medique). Aqu\xED configuras y visualizas las reglas."), /* @__PURE__ */ React.createElement(NotificacionesCard, { T }), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 17, color: T.text, marginBottom: 10 } }, "Recordatorios autom\xE1ticos"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 14 } }, rules.map((r, ri) => {
...
function CajaView({ T }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 12, marginBottom: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Registro de Ventas", sub: ventasCount + " venta" + (ventasCount === 1 ? "" : "s") + " " + periodoLbl }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement(AdBtn, { T, onClick: () => setCierre(true) }, "Cierre del d\xEDa"), /* @__PURE__ */ React.createElement(AdBtn, { T, primary: true, onClick: () => setMov(true) }, "+ Movimiento"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" } }, chip("hoy", "Hoy"), chip("semana", "Esta semana"), chip("mes", "Este mes")), /* @__PURE__ */ React.createElement("div", { style: { background: T.surface, border: "1px solid " + T.line, borderRadius: 10, padding: "16px 18px", marginBottom: 18 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 12, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13, fontWeight: 600, color: T.text } }, "Tratamientos que m\xE1s venden \xB7 ", tratScope === "mes" ? "este mes" : "hist\xF3rico"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, [["mes", "Este mes"], ["hist", "Hist\xF3rico"]].map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setTratScope(k), style: { fontFamily: T.sans, fontSize: 11, padding: "6px 12px", borderRadius: 999, cursor: "pointer", border: "1px solid " + (tratScope === k ? T.accent : T.line), background: tratScope === k ? T.surface2 : T.surface, color: tratScope === k ? T.text : T.textMute } }, l)))), topTrat.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: T.textFaint } }, "A\xFAn no hay ventas ", tratScope === "mes" ? "este mes" : "registradas", ". Aparecer\xE1 cuando cobres atenciones desde la ficha del paciente."), topTrat.map((t, i) => {
...
function ContraloriaView({ T, patients, appts }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SecHead, { T, title: "Contralor IA", sub: "Gestionar deja de ser reaccionar: la inteligencia anticipa y alerta" }), /* @__PURE__ */ React.createElement(IAHero, { T, color: "#8B5CF6", title: "Control de calidad continuo", sub: "Verificaci\xF3n autom\xE1tica de registros \xB7 alertas de inconsistencias \xB7 control de calidad continuo.", icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }), /* @__PURE__ */ React.createElement("path", { d: "M9 12l2 2 4-4" })) }), ok ? /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(31,138,91,.08)", border: "1px solid #1F8A5B44", borderRadius: 12, padding: "24px", textAlign: "center", maxWidth: 760 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 19, color: "#1F8A5B" } }, "\u2713 Todo en orden"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13, color: T.textMute, marginTop: 6 } }, "No se detectaron inconsistencias en los registros.")) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10, maxWidth: 780 } }, alertas.map((a, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: window.JCDS && (typeof jcdsLux === "function" && jcdsLux()) ? { display: "flex", alignItems: "center", gap: 14, ...window.JCDS.card(T), borderLeft: "4px solid " + a.c, padding: "14px 16px" } : { display: "flex", alignItems: "center", gap: 14, background: T.surface, border: "1px solid " + T.line, borderLeft: "4px solid " + a.c, borderRadius: 10, padding: "14px 16px" } }, /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, width: 40, height: 40, borderRadius: 10, background: a.c + "1c", color: a.c, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: T.serif, fontSize: 18, fontWeight: 600 } }, a.n), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13.5, fontWeight: 600, color: T.text } }, a.t), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute, marginTop: 2 } }, a.d)), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    try {
...
function FlujoCajaChart({ T, title }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { background: T.surface, border: "1px solid " + T.line, borderRadius: 14, padding: "18px 20px", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 600, color: T.text, marginBottom: 16 } }, title || "Flujo de caja \xB7 \xFAltimos 6 meses"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: 14, height: 180 } }, data.map((m) => /* @__PURE__ */ React.createElement("div", { key: m.key, title: "Ganancia de " + m.lbl + ": " + D.fmt(m.neto), style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 6, cursor: "default" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, width: "100%", display: "flex", alignItems: "flex-end", justifyContent: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { title: "Ingresos " + D.fmt(m.ing), style: { width: "40%", height: Math.round(m.ing / maxV * 140) + "px", minHeight: 2, background: "#1F8A5B", borderRadius: "4px 4px 0 0" } }), /* @__PURE__ */ React.createElement("div", { title: "Egresos " + D.fmt(m.egr), style: { width: "40%", height: Math.round(m.egr / maxV * 140) + "px", minHeight: 2, background: "#C0285A", borderRadius: "4px 4px 0 0" } })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute } }, m.lbl)))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, marginTop: 14, justifyContent: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 6, fontFamily: T.sans, fontSize: 11, color: T.textMute } }, /* @__PURE__ */ React.createElement("span", { style: { width: 11, height: 11, borderRadius: 3, background: "#1F8A5B" } }), "Ingresos"), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 6, fontFamily: T.sans, fontSize: 11, color: T.textMute } }, /* @__PURE__ */ React.createElement("span", { style: { width: 11, height: 11, borderRadius: 3, background: "#C0285A" } }), "Egresos")));
}
