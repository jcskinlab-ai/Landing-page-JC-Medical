...
function PacientesView({ T, patients, appts, onOpen, updatePatient, addPatient }) {
  ...
  const tab = (k, l, set, cur) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => {
    set(k);
    setPage(1);
  }, style: { position: "relative", fontFamily: T.sans, fontSize: 12.5, fontWeight: cur === k ? 600 : 500, padding: "9px 2px", cursor: "pointer", border: "none", background: "none", color: cur === k ? T.text : T.textMute, whiteSpace: "nowrap" } }, l, cur === k && /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 0, right: 0, bottom: -1, height: 2, borderRadius: 2, background: T.accent } }));
  const todayTs0 = (() => {
    const d = /* @__PURE__ */ new Date();
    d.setHours(0, 0, 0, 0);
    return d.getTime();
  ...
  const nuevosEsteMes = patients.filter((p) => {
    if (!p.fechaTs) return false;
    const d = new Date(p.fechaTs);
  ...
  const recientes7d = Object.keys(opened).filter((id) => Date.now() - (opened[id] || 0) <= 7 * 864e5).length;
  ...
  const kpis = [
    { label: "Total pacientes", value: patients.length, sub: "+" + nuevosEsteMes + " este mes", color: "#1F8A5B", icon: /* @__PURE__ */ React.createElement("path", { d: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" }) },
    { label: "Agendados hoy", value: agendadosHoy, sub: pct(agendadosHoy) + "% del total", color: "#2E6F9E", icon: /* @__PURE__ */ React.createElement("path", { d: "M3 4h18M8 2v4M16 2v4M4 8h16v13H4z" }) },
    { label: "Pendientes", value: sinConsentCount, sub: pct(sinConsentCount) + "% del total", color: "#C9A227", icon: /* @__PURE__ */ React.createElement("path", { d: "M12 7v5l3 3M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z" }) },
    { label: "Interesados", value: interesadosCount, sub: pct(interesadosCount) + "% del total", color: "#7C5CBF", icon: /* @__PURE__ */ React.createElement("path", { d: "M11.5 21S3 15.6 3 9.5A4.5 4.5 0 0 1 11.5 7 4.5 4.5 0 0 1 20 9.5C20 15.6 11.5 21 11.5 21z" }) },
    { label: "Recientes", value: recientes7d, sub: "\xDAltimos 7 d\xEDas", color: "#1F8A5B", icon: /* @__PURE__ */ React.createElement("path", { d: "M9 12l2 2 4-4M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" }) }
  ];
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 0 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 12, marginBottom: 16 } }, kpis.map((k) => /* @__PURE__ */ React.createElement("div", { key: k.label, style: kpiCard }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 34, height: 34, borderRadius: 9, background: k.color + "1c", color: k.color, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, k.icon)), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10, letterSpacing: ".08em", textTransform: "uppercase", color: T.textMute, whiteSpace: "nowrap" } }, k.label), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.serif, fontSize: 21, color: T.text, lineHeight: 1.2 } }, k.value))), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: k.color, marginTop: 8, fontWeight: 600 } }, k.sub), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 0, right: 0, bottom: 0, height: 3, background: k.color } })))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, marginBottom: 12, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flex: 1 } }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: T.textFaint, strokeWidth: "1.6", style: { position: "absolute", left: 13, top: "50%", transform: "translateY(-50%)" } }, /* @__PURE__ */ React.createElement("circle", { cx: "11", cy: "11", r: "7" }), /* @__PURE__ */ React.createElement("path", { d: "M21 21l-4.3-4.3" })), /* @__PURE__ */ React.createElement("input", { value: q, onChange: (e) => {
    setQ(e.target.value);
    setPage(1);
  }, placeholder: "Buscar por nombre o RUT del paciente\u2026", style: luxF ? { ...DS.ctl(T), width: "100%", height: DS.h.ctl + 4, padding: "0 14px 0 38px" } : { width: "100%", padding: "12px 14px 12px 38px", borderRadius: 4, border: "1px solid " + T.line, background: T.surface, color: T.text, fontFamily: T.sans, fontSize: 13, outline: "none" } })), /* @__PURE__ */ React.createElement(AdBtn, { T, primary: true, onClick: () => setNuevo(true) }, "+ Paciente")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 18, marginBottom: 10, flexWrap: "wrap", alignItems: "center", borderBottom: "1px solid " + T.lineSoft } }, tab("todos", "Todos", setFilt, filt), tab("recientes", "Recientes", setFilt, filt), tab("calendario", "Calendario", setFilt, filt), tab("agendado", "Agendados", setFilt, filt), tab("comprado", "Comprados", setFilt, filt), tab("interesado", "Interesados", setFilt, filt)), /* @__PURE__ */ React.createElement("button", { onClick: () => setOpenCamp(!openCamp), style: { width: "100%", display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderRadius: 10, marginBottom: 12, cursor: "pointer", background: recitasDue.length ? "rgba(31,138,91,.08)" : T.surface, border: "1px solid " + (recitasDue.length ? "rgba(31,138,91,.35)" : T.line) } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: recitasDue.length ? "#1F8A5B" : T.textMute, strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("path", { d: "M21 11.5a8.5 8.5 0 0 1-12.5 7.5L3 20l1-5A8.5 8.5 0 1 1 21 11.5z" })), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, textAlign: "left", fontFamily: T.sans, fontSize: 12.5, fontWeight: 500, color: T.text } }, "Campa\xF1as de re-cita por WhatsApp", recitasDue.length ? " \xB7 " + recitasDue.length + " para contactar hoy" : ""), /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: T.textMute, strokeWidth: "1.6", style: { transform: openCamp ? "rotate(180deg)" : "none", transition: "transform .2s" } }, /* @__PURE__ */ React.createElement("path", { d: "M6 9l6 6 6-6" }))), openCamp && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 7, marginBottom: 16 } }, recitasDue.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textFaint, padding: "12px 13px", background: T.surface, border: "1px dashed " + T.line, borderRadius: 9, lineHeight: 1.5 } }, "Ning\xFAn paciente cumple hoy su plazo de re-aplicaci\xF3n. Cuando un paciente alcance su ventana (toxina a los 3 meses \xB7 Sculptra a los 2 meses desde su \xFAltima sesi\xF3n), aparecer\xE1 aqu\xED listo para contactar."), recitasDue.sort((a, b) => a.r.due - b.r.due).map(({ p, r }) => /* @__PURE__ */ React.createElement("div", { key: p.id, style: { display: "flex", alignItems: "center", gap: 12, padding: "11px 13px", borderRadius: 9, background: "rgba(31,138,91,.06)", border: "1px solid rgba(31,138,91,.4)" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 13, fontWeight: 500, color: T.text } }, p.name), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textMute, marginTop: 2 } }, r.motivo, " \xB7 cumpli\xF3 su plazo el ", fmtD(r.due))), /* @__PURE__ */ React.createElement(AdTag, { T, tone: "ok" }, "Contactar"), /* @__PURE__ */ React.createElement("a", { href: waLink(p, r), target: "_blank", rel: "noopener", style: { display: "inline-flex", alignItems: "center", gap: 6, fontFamily: T.sans, fontSize: 10.5, color: "#1F8A5B", textDecoration: "none", border: "1px solid #1F8A5B", borderRadius: 7, padding: "8px 11px" } }, "WhatsApp")))), luxF && list.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, padding: "0 10px 9px", borderBottom: "1px solid " + T.line, marginBottom: 2 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 44, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { width: 200, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Paciente \xB7 ", list.length), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Contacto"), /* @__PURE__ */ React.createElement("div", { style: { width: 96, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "\xDAltima cita"), /* @__PURE__ */ React.createElement("div", { style: { width: 96, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Pr\xF3xima cita"), /* @__PURE__ */ React.createElement("div", { style: { width: 130, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Procedimiento"), /* @__PURE__ */ React.createElement("div", { style: { width: 92, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Estado"), /* @__PURE__ */ React.createElement("div", { style: { width: 78, flexShrink: 0, textAlign: "right", fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Visto")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, pageList.map((p, pi) => {
    const m = meta(p);
    ...
    const estadoChip = m.comp ? pill("Comprado", { fg: "#16A34A", bg: "#16A34A1c", bd: "#16A34A33", upper: true }) : m.ag ? pill("Agendado", { fg: T.accent, bg: T.chipBg, bd: T.chipBorder, upper: true }) : pill("Interesado", { fg: T.textMute, bg: "transparent", bd: T.line, upper: true });
    ...
    if (luxF) return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { width: 200, flexShrink: 0, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 14.5, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, p.name), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textMute, marginTop: 3 } }, p.rut || "Sin RUT", p.age ? " \xB7 " + p.age + " a\xF1os" : "")),
      ...
      /* @__PURE__ */ React.createElement("div", { style: { width: 96, flexShrink: 0 } }, calTs(p) ? /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute, whiteSpace: "nowrap" } }, fmtFecha(calTs(p))) : /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, color: T.textFaint } }, "\u2014")),
      /* @__PURE__ */ React.createElement("div", { style: { width: 96, flexShrink: 0 } }, nextTs ? /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 500, color: T.accent, whiteSpace: "nowrap" } }, fmtFecha(nextTs)) : /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, color: T.textFaint } }, "Sin citas pr\xF3ximas")),
      /* @__PURE__ */ React.createElement("div", { style: { width: 130, flexShrink: 0, minWidth: 0, display: "flex", flexWrap: "wrap", gap: 5 } }, lastProc ? pill(lastProc, { fg: T.text, bg: T.surface2 || T.surface, bd: T.line, upper: false }) : /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textFaint } }, "\u2014"), !p.consent && pill("Consent.", { fg: DS.warn, bg: DS.warn + "14", bd: DS.warn + "33", upper: true })),
      /* @__PURE__ */ React.createElement("div", { style: { width: 92, flexShrink: 0 } }, estadoChip),
      /* @__PURE__ */ React.createElement("div", { style: { width: 78, flexShrink: 0, textAlign: "right" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11.5, fontWeight: 500, color: opened[p.id] ? T.accent : T.textFaint, whiteSpace: "nowrap" } }, fmtVisto(opened[p.id])))
    );
    return /* @__PURE__ */ React.createElement("button", { key: p.id, onClick: () => openPatient(p.id), style: { display: "flex", alignItems: "center", gap: 14, width: "100%", textAlign: "left", padding: "14px 6px", cursor: "pointer", background: "none", border: "none", borderBottom: "1px solid " + T.lineSoft } }, /* @__PURE__ */ React.createElement(Avatar, { T, name: p.name, size: 44 }), /* @__PURE__ */ React.createElement("div", { style: { width: 210, flexShrink: 0, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 14.5, fontWeight: 500, color: T.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, p.name), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textMute, marginTop: 3 } }, p.rut, p.age ? " \xB7 " + p.age + " a\xF1os" : "")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, display: "flex", gap: 24, alignItems: "center" } }, p.phone && /* @__PURE__ */ React.createElement("div", { style: { width: 150, flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 8.5, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint, marginBottom: 2 } }, "Tel\xE9fono"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute, whiteSpace: "nowrap" } }, p.phone)), p.email && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 8.5, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint, marginBottom: 2 } }, "Correo"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, p.email))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, flexShrink: 0 } }, nextTs ? /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 500, color: T.accent, whiteSpace: "nowrap" } }, "Pr\xF3xima: ", fmtFecha(nextTs)) : calTs(p) ? /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute, whiteSpace: "nowrap" } }, fmtFecha(calTs(p))) : null, p.tags && p.tags[0] && /* @__PURE__ */ React.createElement(AdTag, { T }, p.tags[0]), !p.consent && /* @__PURE__ */ React.createElement(AdTag, { T, tone: "warn" }, "Consent. pend.")));
  }), list.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "30px 0", textAlign: "center", fontFamily: T.sans, fontSize: 12, color: T.textFaint } }, "Sin resultados.")), list.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: 14, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute } }, "Mostrando ", (pageClamped - 1) * pageSize + 1, " a ", Math.min(pageClamped * pageSize, list.length), " de ", list.length, " pacientes"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setPage((p) => Math.max(1, p - 1)), disabled: pageClamped <= 1, style: { width: 30, height: 30, borderRadius: 8, border: "1px solid " + T.line, background: T.surface, color: T.textMute, cursor: pageClamped <= 1 ? "default" : "pointer", opacity: pageClamped <= 1 ? 0.5 : 1 } }, "\u2039"), Array.from({ length: totalPages }, (_, i) => i + 1).slice(Math.max(0, pageClamped - 3), Math.max(0, pageClamped - 3) + 5).map((n) => /* @__PURE__ */ React.createElement("button", { key: n, onClick: () => setPage(n), style: { width: 30, height: 30, borderRadius: 8, border: "1px solid " + (n === pageClamped ? T.accent : T.line), background: n === pageClamped ? T.accent : T.surface, color: n === pageClamped ? T.onAccent || "#fff" : T.textMute, cursor: "pointer", fontFamily: T.sans, fontSize: 12 } }, n)), /* @__PURE__ */ React.createElement("button", { onClick: () => setPage((p) => Math.min(totalPages, p + 1)), disabled: pageClamped >= totalPages, style: { width: 30, height: 30, borderRadius: 8, border: "1px solid " + T.line, background: T.surface, color: T.textMute, cursor: pageClamped >= totalPages ? "default" : "pointer", opacity: pageClamped >= totalPages ? 0.5 : 1 } }, "\u203A")), /* @__PURE__ */ React.createElement("select", { value: pageSize, onChange: (e) => {
    setPageSize(parseInt(e.target.value, 10));
    setPage(1);
  }, style: { height: 30, borderRadius: 8, border: "1px solid " + T.line, background: T.surface, color: T.textMute, fontFamily: T.sans, fontSize: 11.5, padding: "0 8px" } }, /* @__PURE__ */ React.createElement("option", { value: 10 }, "10 por p\xE1gina"), /* @__PURE__ */ React.createElement("option", { value: 25 }, "25 por p\xE1gina"), /* @__PURE__ */ React.createElement("option", { value: 50 }, "50 por p\xE1gina"))), nuevo && /* @__PURE__ */ React.createElement(NewPatientModal, { T, onClose: () => setNuevo(false), onSave: (p) => {
    addPatient(p);
    setNuevo(false);
  } }));
}
