...
function FichaMedica({ T, patient, updatePatient, removePatient, onBack, onAgendar, initialTab }) {
  ...
  function imprimirFicha() {
    ...
    const sesion = (h) => "<div class='ses'><div class='sd'>" + esc(h.date || "") + " &nbsp;\xB7&nbsp; " + esc(h.proc || "") + (h.units ? " <span class='u'>(" + esc(h.units) + ")</span>" : "") + "</div>" + (h.lote || h.venc || h.temp || h.dilucion ? "<div class='sm'>" + [h.lote && "Lote " + esc(h.lote), h.venc && "Vence " + esc(h.venc), h.temp && "Temp. " + esc(h.temp), h.dilucion && "Diluci\xF3n " + esc(h.dilucion)].filter(Boolean).join(" \xB7 ") + "</div>" : "") + (h.resumen ? "<div class='sn'>" + esc(h.resumen) + "</div>" : "") + (h.note ? "<div class='sn'>" + esc(h.note) + "</div>" : "") + (h.proName ? "<div class='sp'>Realizado por " + esc(h.proName) + "</div>" : "") + "</div>";
    ...
    const footer = "<div class='sig'><div class='sig-l'><div class='sig-line'><div class='sig-name'>" + esc(proName) + "</div><div class='sig-role'>" + esc(proRole) + " &nbsp;\xB7&nbsp; Medicina est\xE9tica</div></div></div>" + (markEl ? "<div class='sig-mark'>" + markEl + "</div>" : "") + "</div><div class='strip'><span>Ficha cl\xEDnica &nbsp;\xB7&nbsp; Emitida " + esc(hoy) + "</span><span>" + clinHandle + ".CL</span></div>";
    const html = "<!doctype html><html><head><meta charset='utf-8'><title>Ficha cl\xEDnica \xB7 " + esc(patient.name) + "</title><link rel='preconnect' href='https://fonts.googleapis.com'><link rel='preconnect' href='https://fonts.gstatic.com' crossorigin><link href='https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,400;1,500&family=Jost:wght@300;400;500&display=swap' rel='stylesheet'><style>" + css + "</style></head><body>" + header + "<div class='doc-type'>Documento cl\xEDnico</div><div style='position:relative'><div class='doc-title'>Ficha <em>cl\xEDnica</em></div><div class='exp-lbl'>Expediente</div></div>" + patBar + "<div class='sec-hd'><em>i</em>&nbsp; Antecedentes</div><div class='grid'>" + field("Alergias", cv("alergias")) + field("Antecedentes m\xF3rbidos", cv("morbidos")) + field("Procedimientos est\xE9ticos previos", cv("esteticos")) + field("Medicamentos", cv("medicamentos")) + field("Antecedentes quir\xFArgicos", cv("quirurgicos") || c.cirugias) + field("Correo electr\xF3nico", patient.email) + "</div><div class='sec-hd'><em>ii</em>&nbsp; H\xE1bitos y piel</div><div class='grid'>" + field("Tabaco", c.tabaco ? c.tabaco + " cigarros/d\xEDa" : "") + field("Alcohol", c.alcohol) + field("Actividad f\xEDsica", c.actividad) + field("Consumo de agua", c.agua) + field("Exposici\xF3n solar", c.expsolar) + field("Bloqueador solar", c.bloqueador) + field("Embarazo / lactancia", c.embarazo) + field("Cuidados de la piel", cv("skincare")) + "</div>" + (patient.notes ? "<div class='sec-hd'>Notas internas</div><div style='font-size:12px;color:#444;white-space:pre-wrap;margin-top:4px'>" + esc(patient.notes) + "</div>" : "") + "<div class='sec-hd'><em>iii</em>&nbsp; Historial de sesiones</div>" + (hist.length ? hist.map(sesion).join("") : "<div style='color:#bbb;font-size:11px;padding:8px 0'>Sin sesiones registradas.</div>") + footer + "</body></html>";
  ...
  function imprimirProc(h) {
    ...
    const html = "<!doctype html><html><head><meta charset='utf-8'><title>Procedimiento \xB7 " + esc(patient.name) + "</title><link rel='preconnect' href='https://fonts.googleapis.com'><link rel='preconnect' href='https://fonts.gstatic.com' crossorigin><link href='https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,400;1,500&family=Jost:wght@300;400;500&display=swap' rel='stylesheet'><style>" + css + "</style></head><body><div class='hdr'>" + logoEl + "<div class='hdr-r'><span class='hdr-name'>" + esc(proName || clinName) + "</span>" + esc(proRole) + "<br>" + esc(clinAddr) + "<span class='hdr-handle'>" + clinHandle + "</span></div></div><div class='doc-type'>Registro de tratamiento</div><div class='title-row'><div class='doc-title'>Procedimiento <em>realizado</em></div><div class='date-box'><div class='date-lbl'>Fecha</div><div class='date-val'>" + dotDate + "</div></div></div><div class='pat-bar'><div class='pat-accent'></div><div class='pat-name'>" + esc(patient.name || "\u2014") + "</div><div class='pat-meta'>" + (patient.rut ? "<span>RUT &nbsp;" + esc(patient.rut) + "</span>" : "") + (patient.age ? "<span>Edad &nbsp;" + esc(patient.age) + " a.</span>" : "") + "</div></div><div class='info-box'><div class='info-col'><div class='info-lbl'>Tratamiento</div><div class='info-val'>" + esc(h.proc || "\u2014") + "</div></div><div style='text-align:right'><div class='info-lbl'>Unidades / Dosis</div><div class='info-val'>" + esc(h.units || "\u2014") + "</div></div></div><div class='sec-hd'><em>i</em>&nbsp; Insumo</div><div class='insumo-grid'>" + insBx("Lote", h.lote) + insBx("Vencimiento", h.venc) + insBx("Diluci\xF3n", h.dilucion) + "</div>" + (h.temp ? "<div style='font-size:10px;color:#999;margin-top:8px'>Temperatura: " + esc(h.temp) + "</div>" : "") + "<div class='sec-hd'><em>ii</em>&nbsp; Resumen de la aplicaci\xF3n</div><div class='text-box'>" + esc(h.resumen || "") + "</div>" + (h.note ? "<div class='sec-hd'>Notas</div><div class='text-box'>" + esc(h.note) + "</div>" : "") + (h.units ? "<div class='total-row'>Total aplicado &nbsp;&nbsp;" + esc(h.units) + "</div>" : "") + "<div class='sig'><div class='sig-l'><div class='sig-line'><div class='sig-name'>" + esc(proName) + "</div><div class='sig-role'>" + esc(proRole) + " &nbsp;\xB7&nbsp; Medicina est\xE9tica</div></div></div>" + (markEl ? "<div class='sig-mark'>" + markEl + "</div>" : "") + "</div><div class='strip'><span>Procedimiento realizado &nbsp;\xB7&nbsp; Emitida " + esc(hoy) + "</span><span>" + clinHandle + ".CL</span></div></body></html>";
    if (window.jcmPrintHTML) window.jcmPrintHTML(html);
    else {
      const w = window.open("", "_blank");
      if (w) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 0 24px" } }, /* @__PURE__ */ React.createElement("button", { onClick: onBack, style: { display: "inline-flex", alignItems: "center", gap: 7, background: "none", border: "none", cursor: "pointer", color: T.textMute, fontFamily: T.sans, fontSize: 11, letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 14, padding: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("path", { d: "M15 18l-6-6 6-6" })), "Pacientes"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(Avatar, { T, name: patient.name, size: 52 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 160 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.serif, fontSize: 26, fontWeight: 300, color: T.text, lineHeight: 1 } }, patient.name), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12.5, fontWeight: 600, color: patient.age ? T.accent : T.textFaint, background: T.accentSoft || "rgba(84,112,127,.12)", border: "1px solid " + (T.accent + "44"), borderRadius: 999, padding: "3px 11px", whiteSpace: "nowrap" } }, patient.age ? patient.age + " a\xF1os" : "Edad \u2014")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginTop: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute } }, "CI ", patient.rut), /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 5, fontFamily: T.sans, fontSize: 11.5, color: activo ? "#1F8A5B" : T.textMute } }, /* @__PURE__ */ React.createElement("span", { style: { width: 7, height: 7, borderRadius: "50%", background: activo ? "#1F8A5B" : T.textFaint } }), estado))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(FAct, { T, href: wa, icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M21 11.5a8.5 8.5 0 0 1-12.5 7.5L3 20l1-5A8.5 8.5 0 1 1 21 11.5z" })) }, "WhatsApp"), /* @__PURE__ */ React.createElement(FAct, { T, href: "mailto:" + (patient.email || ""), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "m3 7 9 6 9-6" })) }, "Correo"), /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => setEditD(true), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M12 20h9" }), /* @__PURE__ */ React.createElement("path", { d: "M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z" })) }, "Editar datos"), /* @__PURE__ */ React.createElement(FAct, { T, onClick: imprimirFicha, icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M6 9V2h12v7" }), /* @__PURE__ */ React.createElement("rect", { x: "6", y: "13", width: "12", height: "8" }), /* @__PURE__ */ React.createElement("path", { d: "M6 17H3v-5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5h-3" })) }, "Imprimir ficha"), /* @__PURE__ */ React.createElement(FAct, { T, primary: true, onClick: () => onAgendar && onAgendar(), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 9h18M8 2v4M16 2v4" })) }, "Agendar cita"), removePatient && /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => {
    ...
    if (!editing && (e.cobro || 0) > 0 && window.cashAdd) {
      try {
        window.cashAdd({ type: "ingreso", kind: "atencion", amount: e.cobro, method: e.metodo || "Efectivo", concept: (e.proc || "Atenci\xF3n").trim() + " \xB7 " + (patient.name || ""), patient: patient.name });
      } catch (e3) {
      }
    }
    try {
...
function NewEntryModal({ T, entry, onClose, onSave, patient, updatePatient, startView }) {
  ...
  const TaF = ({ val, rows, onChange, ph }) => ro ? /* @__PURE__ */ React.createElement("div", { style: roDiv }, val || /* @__PURE__ */ React.createElement("span", { style: { color: T.textFaint } }, "\u2014")) : /* @__PURE__ */ React.createElement("textarea", { value: val, onChange, rows, placeholder: ph, style: ta(rows) });
...
function ResumenIA({ T, patient }) {
  ...
  async function gen() {
    ...
    try {
      if (window.claude && window.claude.complete) {
        const r = await window.claude.complete({ messages: [{ role: "user", content: "Eres asistente cl\xEDnico de una consulta de medicina est\xE9tica en Chile. Redacta en espa\xF1ol un resumen cl\xEDnico breve (4-6 l\xEDneas) del paciente, basado SOLO en estos datos. Indica tratamientos realizados, evoluci\xF3n y puntos a vigilar. No inventes datos.\n\nDATOS: " + ctx() }] });
  ...
  async function ask() {
    ...
    try {
      if (window.claude && window.claude.complete) {
        const r = await window.claude.complete({ messages: [{ role: "user", content: "Responde en espa\xF1ol, breve y cl\xEDnico, SOLO con base en estos datos del paciente. Si no hay dato, dilo.\n\nDATOS: " + ctx() + "\n\nPREGUNTA: " + text }] });
...
function RecetaTab({ T, patient, updatePatient }) {
  ...
  function imprimir(r) {
    ...
    const indHtml = lines.map(function(l, i) {
      return "<div class='ind-item'><div class='ind-num'>" + (i + 1) + "</div><div class='ind-text'>" + esc(l) + "</div></div>";
    }).join("");
    ...
    const docType = isInd ? "Cuidados posteriores" : "Prescripci\xF3n m\xE9dica";
    const titleHtml = isInd ? "Indicaciones <em>post tratamiento</em>" : "Receta <em>m\xE9dica</em>";
    const html = "<!doctype html><html><head><meta charset='utf-8'><title>" + esc(titleOf(r.tipo)) + " \xB7 " + esc(patient.name || "") + "</title><link rel='preconnect' href='https://fonts.googleapis.com'><link rel='preconnect' href='https://fonts.gstatic.com' crossorigin><link href='https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,400;1,500&family=Jost:wght@300;400;500&display=swap' rel='stylesheet'><style>" + css + "</style></head><body><div class='hdr'>" + logoEl + "<div class='hdr-r'><span class='hdr-name'>" + esc(pro || clinName) + "</span>" + esc(proRole) + "<br>" + esc(dir) + "<span class='hdr-handle'>" + clinHandle + "</span></div></div><div class='doc-type'>" + docType + "</div><div class='title-row'><div class='doc-title'>" + titleHtml + "</div><div class='date-box'><div class='date-lbl'>Fecha</div><div class='date-val'>" + dotDate + "</div></div></div><div class='pat-bar'><div class='pat-accent'></div><div class='pat-name'>" + esc(patient.name || "\u2014") + "</div><div class='pat-meta'>" + (patient.rut ? "<span>RUT &nbsp;" + esc(patient.rut) + "</span>" : "") + (patient.age ? "<span>Edad &nbsp;" + esc(patient.age) + " a.</span>" : "") + "</div></div>" + (r.diag ? "<div class='info-box'><div class='info-lbl'>Diagn\xF3stico / Procedimiento</div><div class='info-val'>" + esc(r.diag) + "</div></div>" : "") + "<div class='sec-hd'>" + (isInd ? "Indicaciones" : "Prescripci\xF3n") + "</div>" + (isInd ? lines.length ? indHtml : "<div class='ind-item'><div class='ind-num'>1</div><div class='ind-text' style='color:#ccc'>Sin indicaciones registradas.</div></div>" : "<div class='rp-sym'>Rp.</div><div class='text-box'>" + esc(r.rp).replace(/\n/g, "<br>") + "</div>") + (r.ind ? "<div class='notas'>" + esc(r.ind).replace(/\n/g, "<br>") + "</div>" : "") + (isInd ? "<div class='ctrl-bar'><div class='ctrl-plus'>+</div><div class='ctrl-txt'>Control de evaluaci\xF3n</div></div>" : "") + "<div class='sig'><div class='sig-l'><div class='sig-line'><div class='sig-name'>" + esc(pro) + "</div><div class='sig-role'>" + esc(proRole) + " &nbsp;\xB7&nbsp; Medicina est\xE9tica</div></div></div>" + (markEl ? "<div class='sig-mark'>" + markEl + "</div>" : "") + "</div><div class='strip'><span>" + esc(titleOf(r.tipo)) + " &nbsp;\xB7&nbsp; Emitida " + esc(hoy2) + "</span><span>" + clinHandle + ".CL</span></div></body></html>";
    if (window.jcmPrintHTML) window.jcmPrintHTML(html);
    else {
      const w = window.open("", "_blank");
      if (w) {
