...
function jcmSignFoot(b, proName, docLabel, patientName, fechaLarga, medSig) {
  ...
  const emitida = fechaLarga ? " \xB7 Emitida <span class='fdate'>" + e(fechaLarga) + "</span>" : "";
  return "<div class='signature'><div class='sign-block'><div class='sign-line'></div><div class='sign-name'>" + e(proName || b.clinName) + "</div><div class='sign-role'>" + e(b.proRole) + "</div></div>" + medBlock + "<div class='sign-stamp'>" + stamp + "</div></div><footer class='docfooter'><span class='f-l'>" + e(docLabel) + " \xB7 " + e(patientName) + emitida + "</span><span class='f-r'>" + e(b.handle || b.clinName) + "</span></footer>";
}
...
function jcmApptDePaciente(a, p) {
  if (!a || !p) return false;
  if (a.patId && p.id) return a.patId === p.id;
...
function recitaFor(p) {
  ...
  const _rcMeses = (k, def) => {
    const n = parseFloat(_rc[k]);
    return isFinite(n) && n > 0 ? n : def;
  };
  if (pick === "toxina") {
    fam = "toxina";
    umbral = _rcMeses("recita_meses_toxina", 3);
    precio = jcmProcPrice(lastTox && (lastTox.proc || lastTox.title) || tag) || 15e4;
    motivo = "Toxina \xB7 refuerzo a " + umbral + " meses";
    ...
    fam = "rino";
    umbral = _rcMeses("recita_meses_rino", 10);
    precio = 0;
    motivo = "Rinomodelaci\xF3n \xB7 mantenci\xF3n a " + umbral + " meses";
...
function PacientesView({ T, patients, appts, onOpen, updatePatient, addPatient }) {
  ...
  const recitaRow = (p, r, hecho) => /* @__PURE__ */ React.createElement("div", { key: p.id, style: {
    ...
    border: "1px solid " + (hecho ? T.line : "rgba(31,138,91,.4)"),
    opacity: hecho ? 0.75 : 1
  } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 500, color: hecho ? T.textMute : T.text } }, p.name), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10.5, color: T.textFaint, marginTop: 2 } }, r.motivo, " \xB7 cumpli\xF3 su plazo el ", fmtD(r.due))), /* @__PURE__ */ React.createElement(
    "a",
    {
      href: waLink(p, r),
      target: "_blank",
      rel: "noopener",
      onClick: () => markRecitaSent(p, r),
      style: {
        display: "inline-flex",
        alignItems: "center",
        gap: 6,
        ...
        fontSize: 10.5,
        whiteSpace: "nowrap",
        color: hecho ? T.textMute : "#1F8A5B",
        textDecoration: "none",
        border: "1px solid " + (hecho ? T.line : "#1F8A5B"),
        borderRadius: 7,
        padding: "8px 11px"
      }
    },
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 0 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, marginBottom: 12, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flex: 1 } }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: T.textFaint, strokeWidth: "1.6", style: { position: "absolute", left: 13, top: "50%", transform: "translateY(-50%)" } }, /* @__PURE__ */ React.createElement("circle", { cx: "11", cy: "11", r: "7" }), /* @__PURE__ */ React.createElement("path", { d: "M21 21l-4.3-4.3" })), /* @__PURE__ */ React.createElement("input", { value: q, onChange: (e) => setQ(e.target.value), placeholder: "Buscar por nombre o RUT\u2026", style: luxF ? { ...DS.ctl(T), width: "100%", height: DS.h.ctl + 4, padding: "0 14px 0 38px" } : { width: "100%", padding: "12px 14px 12px 38px", borderRadius: 4, border: "1px solid " + T.line, background: T.surface, color: T.text, fontFamily: T.sans, fontSize: 13, outline: "none" } })), /* @__PURE__ */ React.createElement(AdBtn, { T, primary: true, onClick: () => setNuevo(true) }, "+ Paciente")), /* @__PURE__ */ React.createElement("div", { style: luxF ? { display: "inline-flex", gap: 2, marginBottom: 10, background: T.surface2 || T.surface, border: "1px solid " + T.line, borderRadius: DS.r.seg, padding: 3, maxWidth: "100%", flexWrap: "wrap" } : { display: "flex", gap: 6, marginBottom: 10, flexWrap: "wrap", alignItems: "center" } }, chip("recientes", "Recientes", setFilt, filt), chip("calendario", "Calendario", setFilt, filt), chip("todos", "Todos", setFilt, filt), chip("agendado", "Agendado", setFilt, filt), chip("comprado", "Comprado", setFilt, filt), chip("interesado", "Interesado", setFilt, filt)), /* @__PURE__ */ React.createElement("button", { onClick: () => setOpenCamp(!openCamp), style: { width: "100%", display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderRadius: 10, marginBottom: 12, cursor: "pointer", background: recitasPend.length ? "rgba(31,138,91,.08)" : T.surface, border: "1px solid " + (recitasPend.length ? "rgba(31,138,91,.35)" : T.line) } }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: recitasPend.length ? "#1F8A5B" : T.textMute, strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("path", { d: "M21 11.5a8.5 8.5 0 0 1-12.5 7.5L3 20l1-5A8.5 8.5 0 1 1 21 11.5z" })), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, textAlign: "left", fontFamily: T.sans, fontSize: 12, fontWeight: 500, color: T.text } }, "Campa\xF1as de re-cita por WhatsApp", recitasPend.length ? " \xB7 " + recitasPend.length + " para contactar hoy" : recitasDue.length ? " \xB7 todos contactados hoy" : ""), /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: T.textMute, strokeWidth: "1.6", style: { transform: openCamp ? "rotate(180deg)" : "none", transition: "transform .2s" } }, /* @__PURE__ */ React.createElement("path", { d: "M6 9l6 6 6-6" }))), openCamp && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 7, marginBottom: 16 } }, recitasPend.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 11, color: T.textFaint, padding: "12px 13px", background: T.surface, border: "1px dashed " + T.line, borderRadius: 9, lineHeight: 1.5 } }, recitasDue.length > 0 ? "Ya contactaste a los " + recitasDue.length + " paciente" + (recitasDue.length === 1 ? "" : "s") + " que cumpl\xEDan plazo. Cuando otro alcance su ventana aparecer\xE1 aqu\xED." : "Ning\xFAn paciente cumple hoy su plazo de re-aplicaci\xF3n. Cuando un paciente alcance su ventana (toxina a los 3 meses \xB7 Sculptra a los 2 meses desde su \xFAltima sesi\xF3n), aparecer\xE1 aqu\xED listo para contactar."), recitasPend.slice().sort((a, b) => a.r.due - b.r.due).map(({ p, r }) => recitaRow(p, r, false)), recitasHechas.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: recitasPend.length ? 6 : 0 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setOpenSent(!openSent), style: { width: "100%", display: "flex", alignItems: "center", gap: 9, padding: "10px 13px", borderRadius: 9, cursor: "pointer", background: T.surface, border: "1px solid " + T.line } }, /* @__PURE__ */ React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: T.textMute, strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M20 6L9 17l-5-5" })), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, textAlign: "left", fontFamily: T.sans, fontSize: 11.5, color: T.textMute } }, "Ya contactados \xB7 ", recitasHechas.length, " paciente", recitasHechas.length === 1 ? "" : "s"), /* @__PURE__ */ React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: T.textMute, strokeWidth: "1.6", style: { transform: openSent ? "rotate(180deg)" : "none", transition: "transform .2s" } }, /* @__PURE__ */ React.createElement("path", { d: "M6 9l6 6 6-6" }))), openSent && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 7, marginTop: 7 } }, recitasHechas.slice().sort((a, b) => a.r.due - b.r.due).map(({ p, r }) => recitaRow(p, r, true))))), luxF && list.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, padding: "0 10px 9px", borderBottom: "1px solid " + T.line, marginBottom: 2 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 44, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { width: 210, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Paciente \xB7 ", list.length), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Contacto"), /* @__PURE__ */ React.createElement("div", { style: { width: 158, flexShrink: 0, fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, "Procedimiento"), /* @__PURE__ */ React.createElement("div", { style: { width: 92, flexShrink: 0, textAlign: "right", fontFamily: T.sans, fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: T.textFaint } }, filt === "recientes" ? "Visto" : "\xDAltima cita")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, list.map((p, pi) => {
    const m = meta(p);
...
function FichaMedica({ T, patient, updatePatient, removePatient, onBack, onAgendar, initialTab, appts, updateAppt }) {
  ...
  const TABS = [["fichaclinica", _terms.ficha || "Ficha Cl\xEDnica"], _dental ? ["odontograma", "Odontograma"] : ["mapa", "Mapa facial y antropometr\xEDa"], ["procedimientos", _terms.procedimientos || "Procedimientos"], ["imagenes", "Im\xE1genes"], ["consent", "Consentimientos"], ["receta", "Receta / Indicaciones"], ..._newFeat ? [["presupuesto", "Presupuesto"]] : [], ["facturacion", "Atenciones"], ..._newFeat ? [["examenes", "Ex\xE1menes"]] : [], ["campana", "Campa\xF1a"], ["notas", "Notas"], ["ia", "IA"]];
  ...
  async function imprimirFicha(consentDoc) {
    ...
    let inner = jcmMasthead(b) + "<div class='titleblock'><div><div class='eyebrow'>Documento cl\xEDnico</div><h1 class='doc-title'>Ficha <span class='it'>cl\xEDnica</span></h1></div><div class='folio'><span class='k'>Expediente</span><span class='v'>" + (e((patient.id || "").replace(/[^a-z0-9]/gi, "").slice(-8).toUpperCase()) || "\u2014") + "</span></div></div>" + jcmPband(patient, [["RUT", patient.rut], ["Edad", patient.age ? patient.age + " a\xF1os" : ""], ["Tel\xE9fono", patient.phone]], patient.estado || "Activo") + "<div class='body'>" + body + "</div>" + jcmSignFoot(b, b.proName, "Ficha cl\xEDnica", patient.name, "");
    if (consentDoc) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 0 24px", ...luxF ? { maxWidth: 1180, margin: "0 auto" } : {} } }, /* @__PURE__ */ React.createElement("button", { onClick: onBack, style: { display: "inline-flex", alignItems: "center", gap: 7, background: "none", border: "none", cursor: "pointer", color: T.textMute, fontFamily: T.sans, fontSize: 11, letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 14, padding: 0 } }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("path", { d: "M15 18l-6-6 6-6" })), "Pacientes"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(Avatar, { T, name: patient.name, size: luxF ? 56 : 52 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 160 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.serif, fontSize: luxF ? 30 : 26, fontWeight: luxF ? 400 : 300, letterSpacing: luxF ? "-.01em" : void 0, color: T.text, lineHeight: 1 } }, patient.name), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12.5, fontWeight: 600, color: patient.age ? T.accent : T.textFaint, background: T.accentSoft || "rgba(84,112,127,.12)", border: "1px solid " + (T.accent + "44"), borderRadius: 999, padding: "3px 11px", whiteSpace: "nowrap" } }, patient.age ? patient.age + " a\xF1os" : "Edad \u2014")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginTop: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 11.5, color: T.textMute } }, "CI ", patient.rut), /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 5, fontFamily: T.sans, fontSize: 11.5, color: activo ? "#1F8A5B" : T.textMute } }, /* @__PURE__ */ React.createElement("span", { style: { width: 7, height: 7, borderRadius: "50%", background: activo ? "#1F8A5B" : T.textFaint } }), estado))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, padding: 5, borderRadius: 10, background: T.accentSoft || "rgba(84,112,127,.10)", border: "1px solid " + T.line } }, /* @__PURE__ */ React.createElement(FAct, { T, href: wa, icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M21 11.5a8.5 8.5 0 0 1-12.5 7.5L3 20l1-5A8.5 8.5 0 1 1 21 11.5z" })) }, "WhatsApp"), /* @__PURE__ */ React.createElement(FAct, { T, href: "mailto:" + (patient.email || ""), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "m3 7 9 6 9-6" })) }, "Correo"), /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => {
    ...
    if (!next) {
      window.jcmToast && window.jcmToast("Este paciente no tiene una pr\xF3xima cita agendada.", "info");
      return;
    }
    const dt = /* @__PURE__ */ new Date(next.fecha + "T00:00:00");
    ...
    const proc = (next.proc || "").trim() || "Evaluaci\xF3n general";
    ...
    const msg = window.jcmCitaConfirmMsg ? window.jcmCitaConfirmMsg(patient.name || "", wk, next.time || "", proc, prof, esCtrl) : "Hola " + (patient.name || "") + " \u{1F44B}\n\nTu cita en " + (window.clinicName && window.clinicName() || "la cl\xEDnica") + " qued\xF3 agendada:\n\n\u{1F5D3}\uFE0F Fecha: " + wk.wd + " " + wk.dd + " " + wk.mm + "\n\u23F0 Hora: " + (next.time || "") + " hrs\n\u{1F489} Tratamiento: " + proc + "\n\u{1F468}\u200D\u2695\uFE0F Profesional: " + prof + "\n\nRecuerda llegar 5 min antes. Si necesitas reagendar, av\xEDsanos con 24 h de anticipaci\xF3n.\n\n\xA1Nos vemos pronto!";
    window.open("https://wa.me/" + ph + "?text=" + encodeURIComponent(msg), "_blank", "noopener");
  }, icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" }), /* @__PURE__ */ React.createElement("path", { d: "M13.7 21a2 2 0 0 1-3.4 0" })) }, "Recordatorio")), /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => setEditD(true), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M12 20h9" }), /* @__PURE__ */ React.createElement("path", { d: "M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z" })) }, "Editar datos"), /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => setPortalMod(true), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "11", width: "18", height: "10", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M7 11V8a5 5 0 0 1 10 0v3" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "16", r: "1.4" })) }, "Portal paciente"), /* @__PURE__ */ React.createElement(FAct, { T, onClick: startPrintFicha, icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M6 9V2h12v7" }), /* @__PURE__ */ React.createElement("rect", { x: "6", y: "13", width: "12", height: "8" }), /* @__PURE__ */ React.createElement("path", { d: "M6 17H3v-5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5h-3" })) }, "Imprimir ficha"), /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => goTab("procedimientos"), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M3 3v5h5" }), /* @__PURE__ */ React.createElement("path", { d: "M3.05 13A9 9 0 1 0 6 5.3L3 8" }), /* @__PURE__ */ React.createElement("path", { d: "M12 7v5l3.5 2" })) }, "Historial"), removePatient && /* @__PURE__ */ React.createElement(FAct, { T, onClick: () => {
    setConfirmDel(true);
    setDelInput("");
  }, icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6" })) }, "Eliminar"), /* @__PURE__ */ React.createElement("div", { style: { marginLeft: "auto" } }, /* @__PURE__ */ React.createElement(FAct, { T, primary: true, onClick: () => onAgendar && onAgendar(), icon: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M3 9h18M8 2v4M16 2v4" })) }, "Agendar cita")))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: luxF ? 10 : 8, margin: luxF ? "12px 0 2px" : "10px 0 2px" } }, [["Edad", patient.age ? patient.age + " a\xF1os" : "\u2014", true], ["Tel\xE9fono", patient.phone || "\u2014", true], ["Email", patient.email || "\u2014", true], ["Estado", estado, false]].map(([l, v, editable], i) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: l,
      onClick: editable ? () => setEditD(true) : void 0,
      title: editable ? "Haz clic para editar" : void 0,
      style: luxF ? { ...DS.card(T), padding: "8px 13px", minWidth: 0, cursor: editable ? "pointer" : "default", transition: DS.trans("border-color, transform"), ...DS.reveal(i) } : { background: T.surface, border: "1px solid " + T.line, borderRadius: 10, padding: "7px 12px", minWidth: 0, cursor: editable ? "pointer" : "default", transition: "border-color .15s" },
    ...
    /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: luxF ? DS.ft.eyebrow : 9, letterSpacing: luxF ? ".14em" : ".16em", textTransform: "uppercase", color: T.textMute, marginBottom: luxF ? 3 : 2, display: "flex", alignItems: "center", gap: 4 } }, l, editable && /* @__PURE__ */ React.createElement("svg", { width: "9", height: "9", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "2" }, /* @__PURE__ */ React.createElement("path", { d: "M12 20h9M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z" }))),
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "jc-scroll", style: luxF ? { display: "flex", gap: 2, overflowX: "auto", background: T.surface2 || T.surface, border: "1px solid " + T.line, borderRadius: DS.r.seg, padding: 3, margin: "12px 0 12px" } : { display: "flex", gap: 4, overflowX: "auto", borderBottom: "1px solid " + T.line, margin: "10px 0 12px" } }, TABS.map(([k, l]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => goTab(k), style: luxF ? { flexShrink: 0, display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 13px", background: tab === k ? T.surface : "none", boxShadow: tab === k ? "0 1px 2px rgba(0,0,0,.06)" : "none", border: "none", borderRadius: DS.r.ctl, cursor: "pointer", fontFamily: T.sans, fontSize: DS.ft.sub, fontWeight: tab === k ? 600 : 500, color: tab === k ? T.text : T.textMute, whiteSpace: "nowrap", transition: DS.trans("background,box-shadow,color") } : { flexShrink: 0, display: "inline-flex", alignItems: "center", gap: 6, padding: "11px 14px", background: "none", border: "none", borderBottom: "2px solid " + (tab === k ? T.accent : "transparent"), cursor: "pointer", fontFamily: T.sans, fontSize: 12.5, fontWeight: tab === k ? 600 : 400, color: tab === k ? T.text : T.textMute, whiteSpace: "nowrap" } }, k === "ia" && /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: tab === k ? T.accent : T.textMute, strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("rect", { x: "4.5", y: "8", width: "15", height: "10", rx: "3" }), /* @__PURE__ */ React.createElement("path", { d: "M12 4.5V8" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "3.4", r: "1.3" })), l))), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, tab === "ia" && /* @__PURE__ */ React.createElement(FichaIATab, { T, patient, go: setTab }), tab === "mapa" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(FaceMap, { T, value: points, onChange: savePoints, patient, updatePatient, readOnly: true })), tab === "odontograma" && /* @__PURE__ */ React.createElement(Odontograma, { T, patient, updatePatient, readOnly: false }), tab === "fichaclinica" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: luxF ? 12 : 10, marginBottom: luxF ? 12 : 10 } }, [["Notas internas", patient.notes, "#C9A227"], ["Alergias", window.clinVal ? window.clinVal(patient.clinica || {}, "alergias") : (patient.clinica || {}).alergias, "#1F8A5B"], ["Antecedentes", window.clinVal ? window.clinVal(patient.clinica || {}, "morbidos") : (patient.clinica || {}).morbidos, T.accent]].map(([l, v, c], i) => luxF ? /* @__PURE__ */ React.createElement("div", { key: l, style: { ...DS.card(T), padding: "14px 16px", ...DS.reveal(i) } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 6, height: 6, borderRadius: 999, background: c, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: DS.ft.eyebrow, letterSpacing: ".14em", textTransform: "uppercase", color: T.textMute } }, l)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: DS.ft.sub, color: v ? T.text : T.textFaint, lineHeight: 1.5 } }, v || "Sin registros.")) : /* @__PURE__ */ React.createElement("div", { key: l, style: { background: T.surface, border: "1px solid " + T.line, borderRadius: 8, padding: "12px 14px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 5 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 6, height: 6, borderRadius: 999, background: c, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".14em", textTransform: "uppercase", color: T.textMute } }, l)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: v ? T.text : T.textFaint, lineHeight: 1.5 } }, v || "Sin registros.")))), /* @__PURE__ */ React.createElement(FichaClinicaForm, { T, patient, updatePatient })), tab === "imagenes" && /* @__PURE__ */ React.createElement(ImagenesTab, { T, patient, updatePatient }), tab === "consent" && /* @__PURE__ */ React.createElement(ConsentTab, { T, patient, updatePatient }), tab === "receta" && /* @__PURE__ */ React.createElement(RecetaTab, { T, patient, updatePatient }), tab === "presupuesto" && (_dental && window.PlanDentalTab ? /* @__PURE__ */ React.createElement(PlanDentalTab, { T, patient, updatePatient }) : /* @__PURE__ */ React.createElement(PresupuestoTab, { T, patient, updatePatient })), tab === "examenes" && /* @__PURE__ */ React.createElement(ExamenesTab, { T, patient }), tab === "facturacion" && /* @__PURE__ */ React.createElement(FacturacionTab, { T, patient, updatePatient, onOpenSession: (hi) => {
    setEditIdx(hi);
    setViewMode(true);
    setNewEntry(true);
...
function jcmConsentsForVertical(list, dental) {
  ...
  return (list || []).filter(function(c) {
    return !!c && (!c.vertical || c.vertical === vert);
  });
}
...
function jcmDentalAICtx(patient, api) {
  ...
  var odo = "";
  try {
    odo = W.odontoResumenTexto ? W.odontoResumenTexto(patient) : "";
  } catch (e) {
    odo = "";
  }
  ...
  var plan = { items: [] };
  try {
    if (W.planGet) plan = W.planGet(patient) || plan;
  } catch (e) {
  }
  var items = plan.items || [];
  try {
    if (W.planOrdenado) items = W.planOrdenado(items) || items;
  } catch (e) {
  }
  var linea = function(it) {
    return "- " + (it.proc || "(sin procedimiento)") + (it.pieza ? " \xB7 pieza " + it.pieza : "") + " \xB7 prioridad " + (it.prioridad || "media") + " \xB7 " + (it.estado || "pendiente");
  };
  var pend = [], hechos = [], i;
  for (i = 0; i < items.length; i++) (items[i].estado === "hecho" ? hechos : pend).push(items[i]);
  out.push("PLAN DE TRATAMIENTO \xB7 PENDIENTES (" + pend.length + ", ordenados por urgencia cl\xEDnica):\n" + (pend.length ? pend.map(linea).join("\n") : "- Sin procedimientos pendientes en el plano."));
  if (hechos.length) out.push("PLAN DE TRATAMIENTO \xB7 YA REALIZADOS (" + hechos.length + "):\n" + hechos.map(linea).join("\n"));
  if (plan.aprobacion) out.push("Plan aprobado por el paciente.");
  return out.join("\n\n");
}
const JCM_DENTAL_AI_BASE = "Eres un asistente de apoyo para un profesional odont\xF3logo en Chile. Escribes en espa\xF1ol de Chile, con lenguaje cl\xEDnico y sobrio. Trabajas SOLO con los datos entregados: no inventes hallazgos, piezas ni antecedentes. NO emites diagn\xF3sticos definitivos ni indicaciones terap\xE9uticas cerradas: tu salida es ORIENTATIVA y la decisi\xF3n cl\xEDnica es siempre del profesional tratante, que debe confirmarla con examen cl\xEDnico y las im\xE1genes que estime necesarias. No interpretas radiograf\xEDas ni im\xE1genes: no dispones de ellas. Si un dato falta, dilo expl\xEDcitamente en vez de suponerlo.";
const JCM_DENTAL_AI_RESUMEN = JCM_DENTAL_AI_BASE + " Redacta un resumen narrativo breve (5-8 l\xEDneas) del estado dental del paciente y cierra con una secci\xF3n \xABPiezas en riesgo\xBB listando las piezas que, seg\xFAn lo registrado, requieren atenci\xF3n prioritaria y por qu\xE9. Si no hay hallazgos registrados, dilo.";
const JCM_DENTAL_AI_PLAN = JCM_DENTAL_AI_BASE + " Prop\xF3n un ORDEN SUGERIDO para los procedimientos pendientes, agrupado en tres etapas y en este criterio de urgencia: 1) dolor, infecci\xF3n o riesgo de p\xE9rdida de la pieza; 2) funci\xF3n (masticaci\xF3n, restauraci\xF3n, rehabilitaci\xF3n); 3) est\xE9tico. Para cada procedimiento indica en una l\xEDnea por qu\xE9 va en esa etapa. No inventes procedimientos que no est\xE9n en la lista. Cierra recordando que es una propuesta orientativa que el profesional debe validar y ajustar con el paciente.";
function ResumenIA({ T, patient }) {
  ...
  function localSummary() {
    ...
    if (_dental) lines.push("", jcmDentalAICtx(patient), "", "Orientativo: revisa el odontograma y confirma con examen cl\xEDnico.");
  ...
  function localPlan() {
    ...
    let items = p.items || [];
    try {
      if (window.planOrdenado) items = window.planOrdenado(items) || items;
    } catch (e) {
    }
    ...
    const etapa = { alta: "1 \xB7 Dolor, infecci\xF3n o riesgo de p\xE9rdida", media: "2 \xB7 Funci\xF3n", baja: "3 \xB7 Est\xE9tico" };
    const out = ["Orden sugerido (orientativo \xB7 debe validarlo el profesional):"];
    ["alta", "media", "baja"].forEach((pr) => {
      const g = pend.filter((it) => (it.prioridad || "media") === pr);
      if (!g.length) return;
      out.push("", etapa[pr] + ":");
      g.forEach((it) => out.push("  \u2022 " + (it.proc || "(sin procedimiento)") + (it.pieza ? " \xB7 pieza " + it.pieza : "")));
    });
    return out.join("\n");
  }
  async function genPlan() {
    ...
    try {
      if (window.mediqueAI) {
        const res = await window.mediqueAI([{ role: "user", content: "DATOS DEL PACIENTE:\n" + ctx() + "\n\nProp\xF3n el orden sugerido del plan de tratamiento." }], {}, { system: JCM_DENTAL_AI_PLAN, max_tokens: 700 });
  ...
  async function gen() {
    ...
    try {
      if (window.mediqueAI) {
        const system = _dental ? JCM_DENTAL_AI_RESUMEN : "Eres asistente cl\xEDnico de una consulta de medicina est\xE9tica en Chile. Redacta en espa\xF1ol un resumen cl\xEDnico breve (4-6 l\xEDneas) del paciente, basado SOLO en estos datos. Indica tratamientos realizados, evoluci\xF3n y puntos a vigilar. No inventes datos.";
  ...
  async function ask() {
    ...
    try {
      if (window.mediqueAI) {
        const system = _dental ? JCM_DENTAL_AI_BASE + " Responde breve, en 2-5 l\xEDneas, solo con base en los datos entregados. Si el dato no est\xE1, dilo." : "Responde en espa\xF1ol, breve y cl\xEDnico, SOLO con base en los datos del paciente que te dan. Si no hay dato, dilo.";
  ...
  })(), _dental && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 10, letterSpacing: ".2em", textTransform: "uppercase", color: T.accent } }, "Plan de tratamiento sugerido \xB7 IA"), /* @__PURE__ */ React.createElement(AdBtn, { T, small: true, primary: true, onClick: genPlan }, planLoad ? "Ordenando\u2026" : plan ? "Regenerar" : "Sugerir orden")), /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(106,130,150,.10)", border: "1px solid " + T.line, borderRadius: 8, padding: "12px 14px", fontFamily: T.sans, fontSize: 11, color: T.textMute, lineHeight: 1.5, marginBottom: 14 } }, "Ordena los procedimientos ", /* @__PURE__ */ React.createElement("b", null, "ya registrados"), " en el plano de tratamiento seg\xFAn urgencia cl\xEDnica (dolor o infecci\xF3n \u2192 funci\xF3n \u2192 est\xE9tico). Es una propuesta ", /* @__PURE__ */ React.createElement("b", null, "orientativa"), ": no constituye diagn\xF3stico y la decisi\xF3n cl\xEDnica es del profesional tratante."), /* @__PURE__ */ React.createElement("div", { style: { minHeight: 64, background: T.surface, border: "1px solid " + T.line, borderRadius: 8, padding: "16px", fontFamily: T.sans, fontSize: 13, color: plan ? T.text : T.textFaint, lineHeight: 1.7, whiteSpace: "pre-wrap" } }, planLoad ? "Revisando el odontograma y el plano de tratamiento\u2026" : plan || "Toca \xABSugerir orden\xBB para proponer una secuencia de los procedimientos pendientes.")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16, background: "rgba(106,130,150,.08)", border: "1px solid " + T.line, borderRadius: 10, padding: "14px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 10 } }, /* @__PURE__ */ React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: T.accent, strokeWidth: "1.6" }, /* @__PURE__ */ React.createElement("rect", { x: "4.5", y: "8", width: "15", height: "10", rx: "3" }), /* @__PURE__ */ React.createElement("path", { d: "M12 4.5V8" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "3.4", r: "1.3" })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: T.sans, fontSize: 12, fontWeight: 600, color: T.text } }, "Asistente IA")), ans.map((m, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontFamily: T.sans, fontSize: 12.5, lineHeight: 1.55, color: m.role === "user" ? T.accent : T.text, padding: "5px 0", whiteSpace: "pre-wrap" } }, m.role === "user" ? "\u203A " : "", m.content)), asking && /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12, color: T.textMute, padding: "4px 0" } }, "Pensando\u2026"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginTop: 8 } }, /* @__PURE__ */ React.createElement("input", { value: q, onChange: (e) => setQ(e.target.value), onKeyDown: (e) => {
    if (e.key === "Enter") ask();
...
function ExamenesTab({ T, patient }) {
  ...
  function crearOrden() {
    ...
    const o = { id: "lo" + Date.now(), patId: patient.id, patName: patient.name, examenes: lista.join(", "), tipo: tipoOrden, estado: "Solicitado", fecha: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10), prof };
    let all = [];
    try {
    ...
    setTimeout(() => imprimirOrden(o), 120);
  }
  function imprimirOrden(o) {
    ...
    let fechaLarga = o.fecha;
    try {
      const d = /* @__PURE__ */ new Date(o.fecha + "T00:00:00");
      fechaLarga = d.getDate() + " de " + MESES_L[d.getMonth()] + " de " + d.getFullYear();
    } catch (_) {
    }
    const items = (o.examenes || "").split(",").map((s) => s.trim()).filter(Boolean);
    const folio = "N\xB0 " + ("" + (o.id || "")).replace(/\D/g, "").slice(-6);
    const titleBlock = "<div class='titleblock'><div><div class='eyebrow'>Solicitud de ex\xE1menes</div><h1 class='doc-title'>Orden de <span class='it'>ex\xE1menes</span></h1></div><div class='folio'><span class='k'>Folio</span><span class='vbig'>" + e(folio) + "</span></div></div>";
    const pband = jcmPband(patient, [["RUT / CI", patient.rut], ["Edad", patient.age ? patient.age + " a\xF1os" : ""], ["Fecha", fechaLarga]], o.estado || "Solicitado");
    const listHTML = "<ol class='indlist'>" + items.map((it) => "<li><span class='num'></span><span class='txt'>" + e(it) + "</span></li>").join("") + "</ol>";
    const tipoBox = o.tipo ? "<div class='diag'><div class='dx-tick'></div><div class='dx-k'>Modalidad</div><div class='dx-v'>" + e(o.tipo === "Interno" ? "Toma interna en la cl\xEDnica" : "Toma externa (laboratorio)") + "</div></div>" : "";
    const body = "<div class='body'>" + tipoBox + "<div class='section'><div class='section-head'><span class='sh-label'>Ex\xE1menes solicitados</span><span class='sh-num'>" + items.length + "</span><span class='sh-rule'></span></div>" + (items.length ? listHTML : "<div class='empty-note'>Sin ex\xE1menes.</div>") + "</div></div>";
    const signFoot = jcmSignFoot(b, o.prof || b.proName, "Orden de ex\xE1menes", patient.name || "", fechaLarga, null);
    const inner = jcmMasthead(b) + titleBlock + pband + body + signFoot;
    jcmPrintDoc("Orden de ex\xE1menes \xB7 " + (patient.name || ""), b, inner);
  }
  function persist(n) {
    setFiles(n);
    try {
...
const RX_RAPIDAS_DENTAL = [
  { id: "ibu400", label: "Ibuprofeno 400 mg", linea: "Ibuprofeno 400 mg \u2014 1 comprimido cada 8 horas \xB7 v\xEDa Oral (con alimentos, por 3 d\xEDas)" },
  { id: "ibu600", label: "Ibuprofeno 600 mg", linea: "Ibuprofeno 600 mg \u2014 1 comprimido cada 8 horas \xB7 v\xEDa Oral (con alimentos, por 3 d\xEDas)" },
  { id: "amx875", label: "Amoxicilina 875 mg", linea: "Amoxicilina 875 mg \u2014 1 comprimido cada 12 horas \xB7 v\xEDa Oral (por 7 d\xEDas, completar el tratamiento)" },
  { id: "cli300", label: "Clindamicina 300 mg", linea: "Clindamicina 300 mg \u2014 1 c\xE1psula cada 8 horas \xB7 v\xEDa Oral (por 7 d\xEDas; alternativa en alergia a penicilina)" }
];
function RecetaTab({ T, patient, updatePatient }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: T.sans, fontSize: 12.5, color: T.textMute, marginBottom: 12, lineHeight: 1.5 } }, "Elige el tipo de documento seg\xFAn tu rol. Al imprimir (tama\xF1o carta) incluye el espacio para la ", /* @__PURE__ */ React.createElement("b", { style: { color: T.text } }, "firma del profesional"), "."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 16 } }, canPrescribe && /* @__PURE__ */ React.createElement("button", { onClick: () => setTipo("receta"), style: seg(tipo === "receta") }, "Receta m\xE9dica", /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 400, marginTop: 2, opacity: 0.85 } }, "M\xE9dico / dentista")), /* @__PURE__ */ React.createElement("button", { onClick: () => setTipo("indicaciones"), style: seg(tipo === "indicaciones") }, "Indicaciones post tratamiento", /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 400, marginTop: 2, opacity: 0.85 } }, "Enfermer\xEDa")), !canPrescribe && /* @__PURE__ */ React.createElement("div", { style: { flexBasis: "100%", fontFamily: T.sans, fontSize: 10.5, color: T.textFaint, marginTop: -4 } }, "Solo M\xE9dico o Dentista pueden crear recetas m\xE9dicas.")), /* @__PURE__ */ React.createElement("div", { style: { background: T.surface, border: "1px solid " + T.line, borderRadius: 12, padding: 18, marginBottom: 18 } }, /* @__PURE__ */ React.createElement("label", { style: { display: "block" } }, /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontFamily: T.sans, fontSize: 9.5, letterSpacing: ".16em", textTransform: "uppercase", color: T.textMute, marginBottom: 6 } }, "Diagn\xF3stico (opcional)"), (() => {
    const DIAG_OPTS = _dental ? ["Caries dental", "Pulpitis", "Absceso periapical", "Pericoronaritis", "Enfermedad periodontal", "Exodoncia simple", "Exodoncia quir\xFArgica", "Endodoncia", "Rehabilitaci\xF3n / pr\xF3tesis", "Ortodoncia", "Implante dental"] : ["Neuromodulaci\xF3n con Toxina botul\xEDnica", "Sculptra de col\xE1geno", "Armonizaci\xF3n facial"];
