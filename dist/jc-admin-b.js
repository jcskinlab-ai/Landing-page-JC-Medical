...
function FichaMedica({ T, patient, updatePatient, removePatient, onBack, onAgendar, initialTab }) {
  ...
  const TABS = [["fichaclinica", "Ficha Cl\xEDnica"], ["mapa", "Mapa facial y antropometr\xEDa"], ["procedimientos", "Procedimientos"], ["imagenes", "Im\xE1genes"], ["consent", "Consentimientos"], ["receta", "Receta / Indicaciones"], ..._newFeat ? [["presupuesto", "Presupuesto"]] : [], ["facturacion", "Atenciones"], ["campana", "Campa\xF1a"], ["notas", "Notas"], ["resumen", "Resumen IA"], ["auditoria", "Auditor\xEDa IA"]];
