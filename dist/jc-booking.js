...
function BookingFlow({ T, D, initialProc, mode, onClose, onAskAssistant }) {
  ...
  const SecHora = /* @__PURE__ */ React.createElement(Section, { T, title: "Hora disponible", hint: day ? day.wd + " " + day.dd + " " + day.mm : "Selecciona un d\xEDa primero" }, !day ? /* @__PURE__ */ React.createElement(Empty, { T }, "Primero elige un d\xEDa.") : /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 } }, day.slots.map((s) => /* @__PURE__ */ React.createElement("button", { key: s.time, disabled: s.taken, onClick: () => setTime(s.time), style: {
    padding: "12px 4px",
    borderRadius: 4,
