...
const JC_GAMES = [
  ...
  {
    id: "mina",
    nm: "Mapa de Punci\xF3n",
    d: "Evita los nervios faciales",
    ic: "\u{1F9ED}",
    url: "arcade/games/jc/index.html?game=mina",
    c: "#54707F",
    rk: "acc_mina",
    base: 300,
    inst: "Marca zonas seguras sin tocar un nervio facial. Cada n\xFAmero indica cu\xE1ntos nervios hay cerca. Cambia a modo bandera para marcarlos."
  },
  {
    id: "glowlab",
    nm: "Glow Lab",
    d: "Arrastra para combinar insumos",
    ic: "\u{1F9EA}",
    url: "arcade/games/jc/index.html?game=glowlab",
    c: "#9C8AB5",
    rk: "glowlab_best",
    base: 1500,
    inst: "Desliza el dedo sobre una ficha hacia una vecina para intercambiarlas. Alinea 3 o m\xE1s iguales y \xA1estallan! Tienes 25 movimientos \u2014 como Candy Crush."
  }
];
