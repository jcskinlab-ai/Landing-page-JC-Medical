...
const PUNCION_PRODUCTS = [
  ...
  { id: "sculptra", label: "Sculptra de col\xE1geno", unit: "vial", color: "#C0285A" }
];
function prodOf(id) {
...
function aureoCompute(lm, W, H, opts) {
  ...
  const recs = [];
  if (t3 > 37) recs.push("Tercio inferior dominante: evaluar proyecci\xF3n de ment\xF3n y equilibrio con sculptra / relleno.");
...
function RickettsTool({ T, patient, updatePatient }) {
  ...
  if (report) {
    ...
    if (prot) {
      rickRecs.push("Labios por delante de la l\xEDnea E: valorar proyecci\xF3n de ment\xF3n con sculptra o relleno para equilibrar el perfil.");
    ...
    if (retr) {
      ...
      rickRecs.push("Evaluar la proyecci\xF3n del ment\xF3n (sculptra o relleno) seg\xFAn el caso.");
    }
