...
var JCM_FAQ=[
 ...
 {k:['evaluacion se descuenta','descuento evaluacion','la evaluacion se paga','cuesta la evaluacion','vale la evaluacion'],a:'La evaluación cuesta $10.000 y se <b>descuenta del tratamiento</b> si decides realizarlo. Es una inversión que evita gastos innecesarios.'},
...
function jcmBotAnswer(qRaw){var q=_norm(qRaw);
  ...
  if(has('agendar','reserva','cita'))
    return done('Puedes agendar con el botón verde de WhatsApp o &laquo;Agendar evaluación&raquo;. La evaluación cuesta $10.000 y se descuenta del tratamiento.',['¿En qué consiste la evaluación?','Precios','¿Qué es el Bótox?']);
  ...
  if(t){var e=KB[t];
    if(a==='precio'){var p=_price(e.pk);return done('<b>'+e.nm+'</b><br>'+(p.length?p.join('<br>'):'Te confirmo el valor exacto en tu evaluación.')+'<br><br>La evaluación cuesta $10.000 y se descuenta del tratamiento.',sugT(t,'precio'));}
