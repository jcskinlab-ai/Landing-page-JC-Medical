...
function SemanaGrid({ T, week, appts, onNew, onEdit, updateAppt, removeAppt, onDay, onVerFicha }) {
  ...
  // JC Medical: jornada algo más compacta (62 px/hora) para ver casi todo el día sin scroll. Otras clínicas: 70.
  const WPX = (typeof clinicSeeded === "function" && clinicSeeded()) ? 62 : 70, WK_OPEN = 8, WK_CLOSE = 20; // jornada 08:00–20:00; cada hora (incl. 20:00) es una casilla completa
